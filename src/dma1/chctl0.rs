#[doc = "Register `CHCTL0` reader"]
pub type R = crate::R<Chctl0Spec>;
#[doc = "Register `CHCTL0` writer"]
pub type W = crate::W<Chctl0Spec>;
...
impl W {
    #[doc = "Bits 0:1 - desc SINC"]
    #[inline(always)]
    pub fn sinc(&mut self) -> SincW<'_, Chctl0Spec> {
        SincW::new(self, 0)
    }
    #[doc = "Bits 2:3 - desc DINC"]
    #[inline(always)]
    pub fn dinc(&mut self) -> DincW<'_, Chctl0Spec> {
        DincW::new(self, 2)
    }
    #[doc = "Bit 4 - desc SRPTEN"]
    #[inline(always)]
    pub fn srpten(&mut self) -> SrptenW<'_, Chctl0Spec> {
        SrptenW::new(self, 4)
    }
    #[doc = "Bit 5 - desc DRPTEN"]
    #[inline(always)]
    pub fn drpten(&mut self) -> DrptenW<'_, Chctl0Spec> {
        DrptenW::new(self, 5)
    }
    #[doc = "Bit 6 - desc SNSEQEN"]
    #[inline(always)]
    pub fn snseqen(&mut self) -> SnseqenW<'_, Chctl0Spec> {
        SnseqenW::new(self, 6)
    }
    #[doc = "Bit 7 - desc DNSEQEN"]
    #[inline(always)]
    pub fn dnseqen(&mut self) -> DnseqenW<'_, Chctl0Spec> {
        DnseqenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - desc HSIZE"]
    #[inline(always)]
    pub fn hsize(&mut self) -> HsizeW<'_, Chctl0Spec> {
        HsizeW::new(self, 8)
    }
    #[doc = "Bit 10 - desc LLPEN"]
    #[inline(always)]
    pub fn llpen(&mut self) -> LlpenW<'_, Chctl0Spec> {
        LlpenW::new(self, 10)
    }
    #[doc = "Bit 11 - desc LLPRUN"]
    #[inline(always)]
    pub fn llprun(&mut self) -> LlprunW<'_, Chctl0Spec> {
        LlprunW::new(self, 11)
    }
    #[doc = "Bit 12 - desc IE"]
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<'_, Chctl0Spec> {
        IeW::new(self, 12)
    }
    #[doc = "Bits 14:15 - desc HPROT"]
    #[inline(always)]
    pub fn hprot(&mut self) -> HprotW<'_, Chctl0Spec> {
        HprotW::new(self, 14)
    }
}
#[doc = "desc CHCTL0\n\nYou can [`read`](crate::Reg::read) this register and get [`chctl0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`chctl0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Chctl0Spec;
impl crate::RegisterSpec for Chctl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`chctl0::R`](R) reader structure"]
impl crate::Readable for Chctl0Spec {}
#[doc = "`write(|w| ..)` method takes [`chctl0::W`](W) writer structure"]
impl crate::Writable for Chctl0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CHCTL0 to value 0x1000"]
impl crate::Resettable for Chctl0Spec {
