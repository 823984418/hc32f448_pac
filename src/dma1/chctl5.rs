#[doc = "Register `CHCTL5` reader"]
pub type R = crate::R<Chctl5Spec>;
#[doc = "Register `CHCTL5` writer"]
pub type W = crate::W<Chctl5Spec>;
...
impl W {
    #[doc = "Bits 0:1 - desc SINC"]
    #[inline(always)]
    pub fn sinc(&mut self) -> SincW<'_, Chctl5Spec> {
        SincW::new(self, 0)
    }
    #[doc = "Bits 2:3 - desc DINC"]
    #[inline(always)]
    pub fn dinc(&mut self) -> DincW<'_, Chctl5Spec> {
        DincW::new(self, 2)
    }
    #[doc = "Bit 4 - desc SRPTEN"]
    #[inline(always)]
    pub fn srpten(&mut self) -> SrptenW<'_, Chctl5Spec> {
        SrptenW::new(self, 4)
    }
    #[doc = "Bit 5 - desc DRPTEN"]
    #[inline(always)]
    pub fn drpten(&mut self) -> DrptenW<'_, Chctl5Spec> {
        DrptenW::new(self, 5)
    }
    #[doc = "Bit 6 - desc SNSEQEN"]
    #[inline(always)]
    pub fn snseqen(&mut self) -> SnseqenW<'_, Chctl5Spec> {
        SnseqenW::new(self, 6)
    }
    #[doc = "Bit 7 - desc DNSEQEN"]
    #[inline(always)]
    pub fn dnseqen(&mut self) -> DnseqenW<'_, Chctl5Spec> {
        DnseqenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - desc HSIZE"]
    #[inline(always)]
    pub fn hsize(&mut self) -> HsizeW<'_, Chctl5Spec> {
        HsizeW::new(self, 8)
    }
    #[doc = "Bit 10 - desc LLPEN"]
    #[inline(always)]
    pub fn llpen(&mut self) -> LlpenW<'_, Chctl5Spec> {
        LlpenW::new(self, 10)
    }
    #[doc = "Bit 11 - desc LLPRUN"]
    #[inline(always)]
    pub fn llprun(&mut self) -> LlprunW<'_, Chctl5Spec> {
        LlprunW::new(self, 11)
    }
    #[doc = "Bit 12 - desc IE"]
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<'_, Chctl5Spec> {
        IeW::new(self, 12)
    }
    #[doc = "Bits 14:15 - desc HPROT"]
    #[inline(always)]
    pub fn hprot(&mut self) -> HprotW<'_, Chctl5Spec> {
        HprotW::new(self, 14)
    }
}
#[doc = "desc CHCTL5\n\nYou can [`read`](crate::Reg::read) this register and get [`chctl5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`chctl5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Chctl5Spec;
impl crate::RegisterSpec for Chctl5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`chctl5::R`](R) reader structure"]
impl crate::Readable for Chctl5Spec {}
#[doc = "`write(|w| ..)` method takes [`chctl5::W`](W) writer structure"]
impl crate::Writable for Chctl5Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CHCTL5 to value 0x1000"]
impl crate::Resettable for Chctl5Spec {
