...
impl W {
    #[doc = "Bits 0:1 - desc SINC"]
    #[inline(always)]
    pub fn sinc(&mut self) -> SincW<'_, Chctl2Spec> {
        SincW::new(self, 0)
    }
    #[doc = "Bits 2:3 - desc DINC"]
    #[inline(always)]
    pub fn dinc(&mut self) -> DincW<'_, Chctl2Spec> {
        DincW::new(self, 2)
    }
    #[doc = "Bit 4 - desc SRPTEN"]
    #[inline(always)]
    pub fn srpten(&mut self) -> SrptenW<'_, Chctl2Spec> {
        SrptenW::new(self, 4)
    }
    #[doc = "Bit 5 - desc DRPTEN"]
    #[inline(always)]
    pub fn drpten(&mut self) -> DrptenW<'_, Chctl2Spec> {
        DrptenW::new(self, 5)
    }
    #[doc = "Bit 6 - desc SNSEQEN"]
    #[inline(always)]
    pub fn snseqen(&mut self) -> SnseqenW<'_, Chctl2Spec> {
        SnseqenW::new(self, 6)
    }
    #[doc = "Bit 7 - desc DNSEQEN"]
    #[inline(always)]
    pub fn dnseqen(&mut self) -> DnseqenW<'_, Chctl2Spec> {
        DnseqenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - desc HSIZE"]
    #[inline(always)]
    pub fn hsize(&mut self) -> HsizeW<'_, Chctl2Spec> {
        HsizeW::new(self, 8)
    }
    #[doc = "Bit 10 - desc LLPEN"]
    #[inline(always)]
    pub fn llpen(&mut self) -> LlpenW<'_, Chctl2Spec> {
        LlpenW::new(self, 10)
    }
    #[doc = "Bit 11 - desc LLPRUN"]
    #[inline(always)]
    pub fn llprun(&mut self) -> LlprunW<'_, Chctl2Spec> {
        LlprunW::new(self, 11)
    }
    #[doc = "Bit 12 - desc IE"]
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<'_, Chctl2Spec> {
        IeW::new(self, 12)
    }
    #[doc = "Bits 14:15 - desc HPROT"]
    #[inline(always)]
    pub fn hprot(&mut self) -> HprotW<'_, Chctl2Spec> {
        HprotW::new(self, 14)
    }
}
...
#[doc = "`reset()` method sets CHCTL2 to value 0x1000"]
