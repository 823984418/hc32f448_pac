#[doc = "Register `CCONR4` reader"]
pub type R = crate::R<Cconr4Spec>;
#[doc = "Register `CCONR4` writer"]
pub type W = crate::W<Cconr4Spec>;
...
impl W {
    #[doc = "Bit 0 - desc CAPMD"]
    #[inline(always)]
    pub fn capmd(&mut self) -> CapmdW<'_, Cconr4Spec> {
        CapmdW::new(self, 0)
    }
    #[doc = "Bit 4 - desc HICP0"]
    #[inline(always)]
    pub fn hicp0(&mut self) -> Hicp0W<'_, Cconr4Spec> {
        Hicp0W::new(self, 4)
    }
    #[doc = "Bit 5 - desc HICP1"]
    #[inline(always)]
    pub fn hicp1(&mut self) -> Hicp1W<'_, Cconr4Spec> {
        Hicp1W::new(self, 5)
    }
    #[doc = "Bit 6 - desc HICP2"]
    #[inline(always)]
    pub fn hicp2(&mut self) -> Hicp2W<'_, Cconr4Spec> {
        Hicp2W::new(self, 6)
    }
    #[doc = "Bit 8 - desc HICP3"]
    #[inline(always)]
    pub fn hicp3(&mut self) -> Hicp3W<'_, Cconr4Spec> {
        Hicp3W::new(self, 8)
    }
    #[doc = "Bit 9 - desc HICP4"]
    #[inline(always)]
    pub fn hicp4(&mut self) -> Hicp4W<'_, Cconr4Spec> {
        Hicp4W::new(self, 9)
    }
    #[doc = "Bit 10 - desc HICP5"]
    #[inline(always)]
    pub fn hicp5(&mut self) -> Hicp5W<'_, Cconr4Spec> {
        Hicp5W::new(self, 10)
    }
    #[doc = "Bit 11 - desc HICP6"]
    #[inline(always)]
    pub fn hicp6(&mut self) -> Hicp6W<'_, Cconr4Spec> {
        Hicp6W::new(self, 11)
    }
    #[doc = "Bit 12 - desc NOFIENCP"]
    #[inline(always)]
    pub fn nofiencp(&mut self) -> NofiencpW<'_, Cconr4Spec> {
        NofiencpW::new(self, 12)
    }
    #[doc = "Bits 13:14 - desc NOFICKCP"]
    #[inline(always)]
    pub fn nofickcp(&mut self) -> NofickcpW<'_, Cconr4Spec> {
        NofickcpW::new(self, 13)
    }
}
#[doc = "desc CCONR4\n\nYou can [`read`](crate::Reg::read) this register and get [`cconr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cconr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cconr4Spec;
impl crate::RegisterSpec for Cconr4Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`cconr4::R`](R) reader structure"]
impl crate::Readable for Cconr4Spec {}
#[doc = "`write(|w| ..)` method takes [`cconr4::W`](W) writer structure"]
impl crate::Writable for Cconr4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CCONR4 to value 0"]
impl crate::Resettable for Cconr4Spec {}
