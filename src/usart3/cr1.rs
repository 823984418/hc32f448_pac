...
#[doc = "Field `CBE` reader - desc CBE"]
pub type CbeR = crate::BitReader;
#[doc = "Field `CBE` writer - desc CBE"]
pub type CbeW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CWKUP` reader - desc CWKUP"]
pub type CwkupR = crate::BitReader;
#[doc = "Field `CWKUP` writer - desc CWKUP"]
pub type CwkupW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CLBD` reader - desc CLBD"]
pub type ClbdR = crate::BitReader;
#[doc = "Field `CLBD` writer - desc CLBD"]
pub type ClbdW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 21 - desc CBE"]
    #[inline(always)]
    pub fn cbe(&self) -> CbeR {
        CbeR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - desc CWKUP"]
    #[inline(always)]
    pub fn cwkup(&self) -> CwkupR {
        CwkupR::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - desc CLBD"]
    #[inline(always)]
    pub fn clbd(&self) -> ClbdR {
        ClbdR::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - desc MS"]
    #[inline(always)]
    pub fn ms(&self) -> MsR {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CR1")
            ...
            .field("cbe", &self.cbe())
            .field("cwkup", &self.cwkup())
            .field("clbd", &self.clbd())
            .field("ms", &self.ms())
...
impl W {
    ...
    #[doc = "Bit 21 - desc CBE"]
    #[inline(always)]
    pub fn cbe(&mut self) -> CbeW<'_, Cr1Spec> {
        CbeW::new(self, 21)
    }
    #[doc = "Bit 22 - desc CWKUP"]
    #[inline(always)]
    pub fn cwkup(&mut self) -> CwkupW<'_, Cr1Spec> {
        CwkupW::new(self, 22)
    }
    #[doc = "Bit 23 - desc CLBD"]
    #[inline(always)]
    pub fn clbd(&mut self) -> ClbdW<'_, Cr1Spec> {
        ClbdW::new(self, 23)
    }
    #[doc = "Bit 24 - desc MS"]
    #[inline(always)]
