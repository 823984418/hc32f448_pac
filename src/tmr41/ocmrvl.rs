#[doc = "Register `OCMRVL` reader"]
pub type R = crate::R<OcmrvlSpec>;
#[doc = "Register `OCMRVL` writer"]
pub type W = crate::W<OcmrvlSpec>;
...
impl W {
    #[doc = "Bit 0 - desc OCFDCL"]
    #[inline(always)]
    pub fn ocfdcl(&mut self) -> OcfdclW<'_, OcmrvlSpec> {
        OcfdclW::new(self, 0)
    }
    #[doc = "Bit 1 - desc OCFPKL"]
    #[inline(always)]
    pub fn ocfpkl(&mut self) -> OcfpklW<'_, OcmrvlSpec> {
        OcfpklW::new(self, 1)
    }
    #[doc = "Bit 2 - desc OCFUCL"]
    #[inline(always)]
    pub fn ocfucl(&mut self) -> OcfuclW<'_, OcmrvlSpec> {
        OcfuclW::new(self, 2)
    }
    #[doc = "Bit 3 - desc OCFZRL"]
    #[inline(always)]
    pub fn ocfzrl(&mut self) -> OcfzrlW<'_, OcmrvlSpec> {
        OcfzrlW::new(self, 3)
    }
    #[doc = "Bits 4:5 - desc OPDCL"]
    #[inline(always)]
    pub fn opdcl(&mut self) -> OpdclW<'_, OcmrvlSpec> {
        OpdclW::new(self, 4)
    }
    #[doc = "Bits 6:7 - desc OPPKL"]
    #[inline(always)]
    pub fn oppkl(&mut self) -> OppklW<'_, OcmrvlSpec> {
        OppklW::new(self, 6)
    }
    #[doc = "Bits 8:9 - desc OPUCL"]
    #[inline(always)]
    pub fn opucl(&mut self) -> OpuclW<'_, OcmrvlSpec> {
        OpuclW::new(self, 8)
    }
    #[doc = "Bits 10:11 - desc OPZRL"]
    #[inline(always)]
    pub fn opzrl(&mut self) -> OpzrlW<'_, OcmrvlSpec> {
        OpzrlW::new(self, 10)
    }
    #[doc = "Bits 12:13 - desc OPNPKL"]
    #[inline(always)]
    pub fn opnpkl(&mut self) -> OpnpklW<'_, OcmrvlSpec> {
        OpnpklW::new(self, 12)
    }
    #[doc = "Bits 14:15 - desc OPNZRL"]
    #[inline(always)]
    pub fn opnzrl(&mut self) -> OpnzrlW<'_, OcmrvlSpec> {
        OpnzrlW::new(self, 14)
    }
    #[doc = "Bits 16:17 - desc EOPNDCL"]
    #[inline(always)]
    pub fn eopndcl(&mut self) -> EopndclW<'_, OcmrvlSpec> {
        EopndclW::new(self, 16)
    }
    #[doc = "Bits 18:19 - desc EOPNUCL"]
    #[inline(always)]
    pub fn eopnucl(&mut self) -> EopnuclW<'_, OcmrvlSpec> {
        EopnuclW::new(self, 18)
    }
    #[doc = "Bits 20:21 - desc EOPDCL"]
    #[inline(always)]
    pub fn eopdcl(&mut self) -> EopdclW<'_, OcmrvlSpec> {
        EopdclW::new(self, 20)
    }
    #[doc = "Bits 22:23 - desc EOPPKL"]
    #[inline(always)]
    pub fn eoppkl(&mut self) -> EoppklW<'_, OcmrvlSpec> {
        EoppklW::new(self, 22)
    }
    #[doc = "Bits 24:25 - desc EOPUCL"]
    #[inline(always)]
    pub fn eopucl(&mut self) -> EopuclW<'_, OcmrvlSpec> {
        EopuclW::new(self, 24)
    }
    #[doc = "Bits 26:27 - desc EOPZRL"]
    #[inline(always)]
    pub fn eopzrl(&mut self) -> EopzrlW<'_, OcmrvlSpec> {
        EopzrlW::new(self, 26)
    }
    #[doc = "Bits 28:29 - desc EOPNPKL"]
    #[inline(always)]
    pub fn eopnpkl(&mut self) -> EopnpklW<'_, OcmrvlSpec> {
        EopnpklW::new(self, 28)
    }
    #[doc = "Bits 30:31 - desc EOPNZRL"]
    #[inline(always)]
    pub fn eopnzrl(&mut self) -> EopnzrlW<'_, OcmrvlSpec> {
        EopnzrlW::new(self, 30)
    }
}
#[doc = "desc OCMRVL\n\nYou can [`read`](crate::Reg::read) this register and get [`ocmrvl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocmrvl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OcmrvlSpec;
impl crate::RegisterSpec for OcmrvlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ocmrvl::R`](R) reader structure"]
impl crate::Readable for OcmrvlSpec {}
#[doc = "`write(|w| ..)` method takes [`ocmrvl::W`](W) writer structure"]
impl crate::Writable for OcmrvlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCMRVL to value 0"]
impl crate::Resettable for OcmrvlSpec {}
