#[doc = "Register `OCSRU` reader"]
pub type R = crate::R<OcsruSpec>;
#[doc = "Register `OCSRU` writer"]
pub type W = crate::W<OcsruSpec>;
...
impl W {
    #[doc = "Bit 0 - desc OCEH"]
    #[inline(always)]
    pub fn oceh(&mut self) -> OcehW<'_, OcsruSpec> {
        OcehW::new(self, 0)
    }
    #[doc = "Bit 1 - desc OCEL"]
    #[inline(always)]
    pub fn ocel(&mut self) -> OcelW<'_, OcsruSpec> {
        OcelW::new(self, 1)
    }
    #[doc = "Bit 2 - desc OCPH"]
    #[inline(always)]
    pub fn ocph(&mut self) -> OcphW<'_, OcsruSpec> {
        OcphW::new(self, 2)
    }
    #[doc = "Bit 3 - desc OCPL"]
    #[inline(always)]
    pub fn ocpl(&mut self) -> OcplW<'_, OcsruSpec> {
        OcplW::new(self, 3)
    }
    #[doc = "Bit 4 - desc OCIEH"]
    #[inline(always)]
    pub fn ocieh(&mut self) -> OciehW<'_, OcsruSpec> {
        OciehW::new(self, 4)
    }
    #[doc = "Bit 5 - desc OCIEL"]
    #[inline(always)]
    pub fn ociel(&mut self) -> OcielW<'_, OcsruSpec> {
        OcielW::new(self, 5)
    }
    #[doc = "Bit 6 - desc OCFH"]
    #[inline(always)]
    pub fn ocfh(&mut self) -> OcfhW<'_, OcsruSpec> {
        OcfhW::new(self, 6)
    }
    #[doc = "Bit 7 - desc OCFL"]
    #[inline(always)]
    pub fn ocfl(&mut self) -> OcflW<'_, OcsruSpec> {
        OcflW::new(self, 7)
    }
}
#[doc = "desc OCSRU\n\nYou can [`read`](crate::Reg::read) this register and get [`ocsru::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocsru::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OcsruSpec;
impl crate::RegisterSpec for OcsruSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ocsru::R`](R) reader structure"]
impl crate::Readable for OcsruSpec {}
#[doc = "`write(|w| ..)` method takes [`ocsru::W`](W) writer structure"]
impl crate::Writable for OcsruSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCSRU to value 0xff00"]
impl crate::Resettable for OcsruSpec {
