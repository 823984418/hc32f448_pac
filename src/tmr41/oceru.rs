#[doc = "Register `OCERU` reader"]
pub type R = crate::R<OceruSpec>;
#[doc = "Register `OCERU` writer"]
pub type W = crate::W<OceruSpec>;
...
impl W {
    #[doc = "Bits 0:1 - desc CHBUFEN"]
    #[inline(always)]
    pub fn chbufen(&mut self) -> ChbufenW<'_, OceruSpec> {
        ChbufenW::new(self, 0)
    }
    #[doc = "Bits 2:3 - desc CLBUFEN"]
    #[inline(always)]
    pub fn clbufen(&mut self) -> ClbufenW<'_, OceruSpec> {
        ClbufenW::new(self, 2)
    }
    #[doc = "Bits 4:5 - desc MHBUFEN"]
    #[inline(always)]
    pub fn mhbufen(&mut self) -> MhbufenW<'_, OceruSpec> {
        MhbufenW::new(self, 4)
    }
    #[doc = "Bits 6:7 - desc MLBUFEN"]
    #[inline(always)]
    pub fn mlbufen(&mut self) -> MlbufenW<'_, OceruSpec> {
        MlbufenW::new(self, 6)
    }
    #[doc = "Bit 8 - desc LMCH"]
    #[inline(always)]
    pub fn lmch(&mut self) -> LmchW<'_, OceruSpec> {
        LmchW::new(self, 8)
    }
    #[doc = "Bit 9 - desc LMCL"]
    #[inline(always)]
    pub fn lmcl(&mut self) -> LmclW<'_, OceruSpec> {
        LmclW::new(self, 9)
    }
    #[doc = "Bit 10 - desc LMMH"]
    #[inline(always)]
    pub fn lmmh(&mut self) -> LmmhW<'_, OceruSpec> {
        LmmhW::new(self, 10)
    }
    #[doc = "Bit 11 - desc LMML"]
    #[inline(always)]
    pub fn lmml(&mut self) -> LmmlW<'_, OceruSpec> {
        LmmlW::new(self, 11)
    }
    #[doc = "Bit 12 - desc MCECH"]
    #[inline(always)]
    pub fn mcech(&mut self) -> McechW<'_, OceruSpec> {
        McechW::new(self, 12)
    }
    #[doc = "Bit 13 - desc MCECL"]
    #[inline(always)]
    pub fn mcecl(&mut self) -> MceclW<'_, OceruSpec> {
        MceclW::new(self, 13)
    }
}
#[doc = "desc OCERU\n\nYou can [`read`](crate::Reg::read) this register and get [`oceru::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`oceru::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OceruSpec;
impl crate::RegisterSpec for OceruSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`oceru::R`](R) reader structure"]
impl crate::Readable for OceruSpec {}
#[doc = "`write(|w| ..)` method takes [`oceru::W`](W) writer structure"]
impl crate::Writable for OceruSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCERU to value 0"]
impl crate::Resettable for OceruSpec {}
