#[doc = "Register `OCERX` reader"]
pub type R = crate::R<OcerxSpec>;
#[doc = "Register `OCERX` writer"]
pub type W = crate::W<OcerxSpec>;
...
impl W {
    #[doc = "Bits 0:1 - desc CHBUFEN"]
    #[inline(always)]
    pub fn chbufen(&mut self) -> ChbufenW<'_, OcerxSpec> {
        ChbufenW::new(self, 0)
    }
    #[doc = "Bits 2:3 - desc CLBUFEN"]
    #[inline(always)]
    pub fn clbufen(&mut self) -> ClbufenW<'_, OcerxSpec> {
        ClbufenW::new(self, 2)
    }
    #[doc = "Bits 4:5 - desc MHBUFEN"]
    #[inline(always)]
    pub fn mhbufen(&mut self) -> MhbufenW<'_, OcerxSpec> {
        MhbufenW::new(self, 4)
    }
    #[doc = "Bits 6:7 - desc MLBUFEN"]
    #[inline(always)]
    pub fn mlbufen(&mut self) -> MlbufenW<'_, OcerxSpec> {
        MlbufenW::new(self, 6)
    }
    #[doc = "Bit 8 - desc LMCH"]
    #[inline(always)]
    pub fn lmch(&mut self) -> LmchW<'_, OcerxSpec> {
        LmchW::new(self, 8)
    }
    #[doc = "Bit 9 - desc LMCL"]
    #[inline(always)]
    pub fn lmcl(&mut self) -> LmclW<'_, OcerxSpec> {
        LmclW::new(self, 9)
    }
    #[doc = "Bit 10 - desc LMMH"]
    #[inline(always)]
    pub fn lmmh(&mut self) -> LmmhW<'_, OcerxSpec> {
        LmmhW::new(self, 10)
    }
    #[doc = "Bit 11 - desc LMML"]
    #[inline(always)]
    pub fn lmml(&mut self) -> LmmlW<'_, OcerxSpec> {
        LmmlW::new(self, 11)
    }
    #[doc = "Bit 12 - desc MCECH"]
    #[inline(always)]
    pub fn mcech(&mut self) -> McechW<'_, OcerxSpec> {
        McechW::new(self, 12)
    }
    #[doc = "Bit 13 - desc MCECL"]
    #[inline(always)]
    pub fn mcecl(&mut self) -> MceclW<'_, OcerxSpec> {
        MceclW::new(self, 13)
    }
}
#[doc = "desc OCERX\n\nYou can [`read`](crate::Reg::read) this register and get [`ocerx::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocerx::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OcerxSpec;
impl crate::RegisterSpec for OcerxSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ocerx::R`](R) reader structure"]
impl crate::Readable for OcerxSpec {}
#[doc = "`write(|w| ..)` method takes [`ocerx::W`](W) writer structure"]
impl crate::Writable for OcerxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCERX to value 0"]
impl crate::Resettable for OcerxSpec {}
