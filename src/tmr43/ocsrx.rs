#[doc = "Register `OCSRX` reader"]
pub type R = crate::R<OcsrxSpec>;
#[doc = "Register `OCSRX` writer"]
pub type W = crate::W<OcsrxSpec>;
...
impl W {
    #[doc = "Bit 0 - desc OCEH"]
    #[inline(always)]
    pub fn oceh(&mut self) -> OcehW<'_, OcsrxSpec> {
        OcehW::new(self, 0)
    }
    #[doc = "Bit 1 - desc OCEL"]
    #[inline(always)]
    pub fn ocel(&mut self) -> OcelW<'_, OcsrxSpec> {
        OcelW::new(self, 1)
    }
    #[doc = "Bit 2 - desc OCPH"]
    #[inline(always)]
    pub fn ocph(&mut self) -> OcphW<'_, OcsrxSpec> {
        OcphW::new(self, 2)
    }
    #[doc = "Bit 3 - desc OCPL"]
    #[inline(always)]
    pub fn ocpl(&mut self) -> OcplW<'_, OcsrxSpec> {
        OcplW::new(self, 3)
    }
    #[doc = "Bit 4 - desc OCIEH"]
    #[inline(always)]
    pub fn ocieh(&mut self) -> OciehW<'_, OcsrxSpec> {
        OciehW::new(self, 4)
    }
    #[doc = "Bit 5 - desc OCIEL"]
    #[inline(always)]
    pub fn ociel(&mut self) -> OcielW<'_, OcsrxSpec> {
        OcielW::new(self, 5)
    }
    #[doc = "Bit 6 - desc OCFH"]
    #[inline(always)]
    pub fn ocfh(&mut self) -> OcfhW<'_, OcsrxSpec> {
        OcfhW::new(self, 6)
    }
    #[doc = "Bit 7 - desc OCFL"]
    #[inline(always)]
    pub fn ocfl(&mut self) -> OcflW<'_, OcsrxSpec> {
        OcflW::new(self, 7)
    }
}
#[doc = "desc OCSRX\n\nYou can [`read`](crate::Reg::read) this register and get [`ocsrx::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocsrx::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OcsrxSpec;
impl crate::RegisterSpec for OcsrxSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ocsrx::R`](R) reader structure"]
impl crate::Readable for OcsrxSpec {}
#[doc = "`write(|w| ..)` method takes [`ocsrx::W`](W) writer structure"]
impl crate::Writable for OcsrxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCSRX to value 0xff00"]
impl crate::Resettable for OcsrxSpec {
