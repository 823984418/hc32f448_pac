#[doc = "Register `SCSRXL` reader"]
pub type R = crate::R<ScsrxlSpec>;
#[doc = "Register `SCSRXL` writer"]
pub type W = crate::W<ScsrxlSpec>;
...
impl W {
    #[doc = "Bits 0:1 - desc BUFEN"]
    #[inline(always)]
    pub fn bufen(&mut self) -> BufenW<'_, ScsrxlSpec> {
        BufenW::new(self, 0)
    }
    #[doc = "Bits 2:4 - desc EVTOS"]
    #[inline(always)]
    pub fn evtos(&mut self) -> EvtosW<'_, ScsrxlSpec> {
        EvtosW::new(self, 2)
    }
    #[doc = "Bit 5 - desc LMC"]
    #[inline(always)]
    pub fn lmc(&mut self) -> LmcW<'_, ScsrxlSpec> {
        LmcW::new(self, 5)
    }
    #[doc = "Bit 8 - desc EVTMS"]
    #[inline(always)]
    pub fn evtms(&mut self) -> EvtmsW<'_, ScsrxlSpec> {
        EvtmsW::new(self, 8)
    }
    #[doc = "Bit 9 - desc EVTDS"]
    #[inline(always)]
    pub fn evtds(&mut self) -> EvtdsW<'_, ScsrxlSpec> {
        EvtdsW::new(self, 9)
    }
    #[doc = "Bit 12 - desc DEN"]
    #[inline(always)]
    pub fn den(&mut self) -> DenW<'_, ScsrxlSpec> {
        DenW::new(self, 12)
    }
    #[doc = "Bit 13 - desc PEN"]
    #[inline(always)]
    pub fn pen(&mut self) -> PenW<'_, ScsrxlSpec> {
        PenW::new(self, 13)
    }
    #[doc = "Bit 14 - desc UEN"]
    #[inline(always)]
    pub fn uen(&mut self) -> UenW<'_, ScsrxlSpec> {
        UenW::new(self, 14)
    }
    #[doc = "Bit 15 - desc ZEN"]
    #[inline(always)]
    pub fn zen(&mut self) -> ZenW<'_, ScsrxlSpec> {
        ZenW::new(self, 15)
    }
}
#[doc = "desc SCSRXL\n\nYou can [`read`](crate::Reg::read) this register and get [`scsrxl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scsrxl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ScsrxlSpec;
impl crate::RegisterSpec for ScsrxlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`scsrxl::R`](R) reader structure"]
impl crate::Readable for ScsrxlSpec {}
#[doc = "`write(|w| ..)` method takes [`scsrxl::W`](W) writer structure"]
impl crate::Writable for ScsrxlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SCSRXL to value 0"]
impl crate::Resettable for ScsrxlSpec {}
