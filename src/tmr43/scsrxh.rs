#[doc = "Register `SCSRXH` reader"]
pub type R = crate::R<ScsrxhSpec>;
#[doc = "Register `SCSRXH` writer"]
pub type W = crate::W<ScsrxhSpec>;
...
impl W {
    #[doc = "Bits 0:1 - desc BUFEN"]
    #[inline(always)]
    pub fn bufen(&mut self) -> BufenW<'_, ScsrxhSpec> {
        BufenW::new(self, 0)
    }
    #[doc = "Bits 2:4 - desc EVTOS"]
    #[inline(always)]
    pub fn evtos(&mut self) -> EvtosW<'_, ScsrxhSpec> {
        EvtosW::new(self, 2)
    }
    #[doc = "Bit 5 - desc LMC"]
    #[inline(always)]
    pub fn lmc(&mut self) -> LmcW<'_, ScsrxhSpec> {
        LmcW::new(self, 5)
    }
    #[doc = "Bit 8 - desc EVTMS"]
    #[inline(always)]
    pub fn evtms(&mut self) -> EvtmsW<'_, ScsrxhSpec> {
        EvtmsW::new(self, 8)
    }
    #[doc = "Bit 9 - desc EVTDS"]
    #[inline(always)]
    pub fn evtds(&mut self) -> EvtdsW<'_, ScsrxhSpec> {
        EvtdsW::new(self, 9)
    }
    #[doc = "Bit 12 - desc DEN"]
    #[inline(always)]
    pub fn den(&mut self) -> DenW<'_, ScsrxhSpec> {
        DenW::new(self, 12)
    }
    #[doc = "Bit 13 - desc PEN"]
    #[inline(always)]
    pub fn pen(&mut self) -> PenW<'_, ScsrxhSpec> {
        PenW::new(self, 13)
    }
    #[doc = "Bit 14 - desc UEN"]
    #[inline(always)]
    pub fn uen(&mut self) -> UenW<'_, ScsrxhSpec> {
        UenW::new(self, 14)
    }
    #[doc = "Bit 15 - desc ZEN"]
    #[inline(always)]
    pub fn zen(&mut self) -> ZenW<'_, ScsrxhSpec> {
        ZenW::new(self, 15)
    }
}
#[doc = "desc SCSRXH\n\nYou can [`read`](crate::Reg::read) this register and get [`scsrxh::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scsrxh::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ScsrxhSpec;
impl crate::RegisterSpec for ScsrxhSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`scsrxh::R`](R) reader structure"]
impl crate::Readable for ScsrxhSpec {}
#[doc = "`write(|w| ..)` method takes [`scsrxh::W`](W) writer structure"]
impl crate::Writable for ScsrxhSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SCSRXH to value 0"]
impl crate::Resettable for ScsrxhSpec {}
