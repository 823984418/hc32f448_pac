#[doc = "Register `OCMRWH` reader"]
pub type R = crate::R<OcmrwhSpec>;
#[doc = "Register `OCMRWH` writer"]
pub type W = crate::W<OcmrwhSpec>;
...
impl W {
    #[doc = "Bit 0 - desc OCFDCH"]
    #[inline(always)]
    pub fn ocfdch(&mut self) -> OcfdchW<'_, OcmrwhSpec> {
        OcfdchW::new(self, 0)
    }
    #[doc = "Bit 1 - desc OCFPKH"]
    #[inline(always)]
    pub fn ocfpkh(&mut self) -> OcfpkhW<'_, OcmrwhSpec> {
        OcfpkhW::new(self, 1)
    }
    #[doc = "Bit 2 - desc OCFUCH"]
    #[inline(always)]
    pub fn ocfuch(&mut self) -> OcfuchW<'_, OcmrwhSpec> {
        OcfuchW::new(self, 2)
    }
    #[doc = "Bit 3 - desc OCFZRH"]
    #[inline(always)]
    pub fn ocfzrh(&mut self) -> OcfzrhW<'_, OcmrwhSpec> {
        OcfzrhW::new(self, 3)
    }
    #[doc = "Bits 4:5 - desc OPDCH"]
    #[inline(always)]
    pub fn opdch(&mut self) -> OpdchW<'_, OcmrwhSpec> {
        OpdchW::new(self, 4)
    }
    #[doc = "Bits 6:7 - desc OPPKH"]
    #[inline(always)]
    pub fn oppkh(&mut self) -> OppkhW<'_, OcmrwhSpec> {
        OppkhW::new(self, 6)
    }
    #[doc = "Bits 8:9 - desc OPUCH"]
    #[inline(always)]
    pub fn opuch(&mut self) -> OpuchW<'_, OcmrwhSpec> {
        OpuchW::new(self, 8)
    }
    #[doc = "Bits 10:11 - desc OPZRH"]
    #[inline(always)]
    pub fn opzrh(&mut self) -> OpzrhW<'_, OcmrwhSpec> {
        OpzrhW::new(self, 10)
    }
    #[doc = "Bits 12:13 - desc OPNPKH"]
    #[inline(always)]
    pub fn opnpkh(&mut self) -> OpnpkhW<'_, OcmrwhSpec> {
        OpnpkhW::new(self, 12)
    }
    #[doc = "Bits 14:15 - desc OPNZRH"]
    #[inline(always)]
    pub fn opnzrh(&mut self) -> OpnzrhW<'_, OcmrwhSpec> {
        OpnzrhW::new(self, 14)
    }
}
#[doc = "desc OCMRWH\n\nYou can [`read`](crate::Reg::read) this register and get [`ocmrwh::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocmrwh::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OcmrwhSpec;
impl crate::RegisterSpec for OcmrwhSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ocmrwh::R`](R) reader structure"]
impl crate::Readable for OcmrwhSpec {}
#[doc = "`write(|w| ..)` method takes [`ocmrwh::W`](W) writer structure"]
impl crate::Writable for OcmrwhSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCMRWH to value 0"]
impl crate::Resettable for OcmrwhSpec {}
