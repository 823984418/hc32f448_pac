#[doc = "Register `OCMRWL` reader"]
pub type R = crate::R<OcmrwlSpec>;
#[doc = "Register `OCMRWL` writer"]
pub type W = crate::W<OcmrwlSpec>;
...
impl W {
    #[doc = "Bit 0 - desc OCFDCL"]
    #[inline(always)]
    pub fn ocfdcl(&mut self) -> OcfdclW<'_, OcmrwlSpec> {
        OcfdclW::new(self, 0)
    }
    #[doc = "Bit 1 - desc OCFPKL"]
    #[inline(always)]
    pub fn ocfpkl(&mut self) -> OcfpklW<'_, OcmrwlSpec> {
        OcfpklW::new(self, 1)
    }
    #[doc = "Bit 2 - desc OCFUCL"]
    #[inline(always)]
    pub fn ocfucl(&mut self) -> OcfuclW<'_, OcmrwlSpec> {
        OcfuclW::new(self, 2)
    }
    #[doc = "Bit 3 - desc OCFZRL"]
    #[inline(always)]
    pub fn ocfzrl(&mut self) -> OcfzrlW<'_, OcmrwlSpec> {
        OcfzrlW::new(self, 3)
    }
    #[doc = "Bits 4:5 - desc OPDCL"]
    #[inline(always)]
    pub fn opdcl(&mut self) -> OpdclW<'_, OcmrwlSpec> {
        OpdclW::new(self, 4)
    }
    #[doc = "Bits 6:7 - desc OPPKL"]
    #[inline(always)]
    pub fn oppkl(&mut self) -> OppklW<'_, OcmrwlSpec> {
        OppklW::new(self, 6)
    }
    #[doc = "Bits 8:9 - desc OPUCL"]
    #[inline(always)]
    pub fn opucl(&mut self) -> OpuclW<'_, OcmrwlSpec> {
        OpuclW::new(self, 8)
    }
    #[doc = "Bits 10:11 - desc OPZRL"]
    #[inline(always)]
    pub fn opzrl(&mut self) -> OpzrlW<'_, OcmrwlSpec> {
        OpzrlW::new(self, 10)
    }
    #[doc = "Bits 12:13 - desc OPNPKL"]
    #[inline(always)]
    pub fn opnpkl(&mut self) -> OpnpklW<'_, OcmrwlSpec> {
        OpnpklW::new(self, 12)
    }
    #[doc = "Bits 14:15 - desc OPNZRL"]
    #[inline(always)]
    pub fn opnzrl(&mut self) -> OpnzrlW<'_, OcmrwlSpec> {
        OpnzrlW::new(self, 14)
    }
    #[doc = "Bits 16:17 - desc EOPNDCL"]
    #[inline(always)]
    pub fn eopndcl(&mut self) -> EopndclW<'_, OcmrwlSpec> {
        EopndclW::new(self, 16)
    }
    #[doc = "Bits 18:19 - desc EOPNUCL"]
    #[inline(always)]
    pub fn eopnucl(&mut self) -> EopnuclW<'_, OcmrwlSpec> {
        EopnuclW::new(self, 18)
    }
    #[doc = "Bits 20:21 - desc EOPDCL"]
    #[inline(always)]
    pub fn eopdcl(&mut self) -> EopdclW<'_, OcmrwlSpec> {
        EopdclW::new(self, 20)
    }
    #[doc = "Bits 22:23 - desc EOPPKL"]
    #[inline(always)]
    pub fn eoppkl(&mut self) -> EoppklW<'_, OcmrwlSpec> {
        EoppklW::new(self, 22)
    }
    #[doc = "Bits 24:25 - desc EOPUCL"]
    #[inline(always)]
    pub fn eopucl(&mut self) -> EopuclW<'_, OcmrwlSpec> {
        EopuclW::new(self, 24)
    }
    #[doc = "Bits 26:27 - desc EOPZRL"]
    #[inline(always)]
    pub fn eopzrl(&mut self) -> EopzrlW<'_, OcmrwlSpec> {
        EopzrlW::new(self, 26)
    }
    #[doc = "Bits 28:29 - desc EOPNPKL"]
    #[inline(always)]
    pub fn eopnpkl(&mut self) -> EopnpklW<'_, OcmrwlSpec> {
        EopnpklW::new(self, 28)
    }
    #[doc = "Bits 30:31 - desc EOPNZRL"]
    #[inline(always)]
    pub fn eopnzrl(&mut self) -> EopnzrlW<'_, OcmrwlSpec> {
        EopnzrlW::new(self, 30)
    }
}
#[doc = "desc OCMRWL\n\nYou can [`read`](crate::Reg::read) this register and get [`ocmrwl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocmrwl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OcmrwlSpec;
impl crate::RegisterSpec for OcmrwlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ocmrwl::R`](R) reader structure"]
impl crate::Readable for OcmrwlSpec {}
#[doc = "`write(|w| ..)` method takes [`ocmrwl::W`](W) writer structure"]
impl crate::Writable for OcmrwlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCMRWL to value 0"]
impl crate::Resettable for OcmrwlSpec {}
