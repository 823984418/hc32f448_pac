#[doc = "Register `OCMRXH` reader"]
pub type R = crate::R<OcmrxhSpec>;
#[doc = "Register `OCMRXH` writer"]
pub type W = crate::W<OcmrxhSpec>;
...
impl W {
    #[doc = "Bit 0 - desc OCFDCH"]
    #[inline(always)]
    pub fn ocfdch(&mut self) -> OcfdchW<'_, OcmrxhSpec> {
        OcfdchW::new(self, 0)
    }
    #[doc = "Bit 1 - desc OCFPKH"]
    #[inline(always)]
    pub fn ocfpkh(&mut self) -> OcfpkhW<'_, OcmrxhSpec> {
        OcfpkhW::new(self, 1)
    }
    #[doc = "Bit 2 - desc OCFUCH"]
    #[inline(always)]
    pub fn ocfuch(&mut self) -> OcfuchW<'_, OcmrxhSpec> {
        OcfuchW::new(self, 2)
    }
    #[doc = "Bit 3 - desc OCFZRH"]
    #[inline(always)]
    pub fn ocfzrh(&mut self) -> OcfzrhW<'_, OcmrxhSpec> {
        OcfzrhW::new(self, 3)
    }
    #[doc = "Bits 4:5 - desc OPDCH"]
    #[inline(always)]
    pub fn opdch(&mut self) -> OpdchW<'_, OcmrxhSpec> {
        OpdchW::new(self, 4)
    }
    #[doc = "Bits 6:7 - desc OPPKH"]
    #[inline(always)]
    pub fn oppkh(&mut self) -> OppkhW<'_, OcmrxhSpec> {
        OppkhW::new(self, 6)
    }
    #[doc = "Bits 8:9 - desc OPUCH"]
    #[inline(always)]
    pub fn opuch(&mut self) -> OpuchW<'_, OcmrxhSpec> {
        OpuchW::new(self, 8)
    }
    #[doc = "Bits 10:11 - desc OPZRH"]
    #[inline(always)]
    pub fn opzrh(&mut self) -> OpzrhW<'_, OcmrxhSpec> {
        OpzrhW::new(self, 10)
    }
    #[doc = "Bits 12:13 - desc OPNPKH"]
    #[inline(always)]
    pub fn opnpkh(&mut self) -> OpnpkhW<'_, OcmrxhSpec> {
        OpnpkhW::new(self, 12)
    }
    #[doc = "Bits 14:15 - desc OPNZRH"]
    #[inline(always)]
    pub fn opnzrh(&mut self) -> OpnzrhW<'_, OcmrxhSpec> {
        OpnzrhW::new(self, 14)
    }
}
#[doc = "desc OCMRXH\n\nYou can [`read`](crate::Reg::read) this register and get [`ocmrxh::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ocmrxh::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OcmrxhSpec;
impl crate::RegisterSpec for OcmrxhSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ocmrxh::R`](R) reader structure"]
impl crate::Readable for OcmrxhSpec {}
#[doc = "`write(|w| ..)` method takes [`ocmrxh::W`](W) writer structure"]
impl crate::Writable for OcmrxhSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OCMRXH to value 0"]
impl crate::Resettable for OcmrxhSpec {}
