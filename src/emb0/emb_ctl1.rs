#[doc = "Register `EMB_CTL1` reader"]
pub type R = crate::R<EmbCtl1Spec>;
#[doc = "Register `EMB_CTL1` writer"]
pub type W = crate::W<EmbCtl1Spec>;
...
impl W {
    #[doc = "Bit 0 - desc CMPEN1"]
    #[inline(always)]
    pub fn cmpen1(&mut self) -> Cmpen1W<'_, EmbCtl1Spec> {
        Cmpen1W::new(self, 0)
    }
    #[doc = "Bit 1 - desc CMPEN2"]
    #[inline(always)]
    pub fn cmpen2(&mut self) -> Cmpen2W<'_, EmbCtl1Spec> {
        Cmpen2W::new(self, 1)
    }
    #[doc = "Bit 2 - desc CMPEN3"]
    #[inline(always)]
    pub fn cmpen3(&mut self) -> Cmpen3W<'_, EmbCtl1Spec> {
        Cmpen3W::new(self, 2)
    }
    #[doc = "Bit 3 - desc CMPEN4"]
    #[inline(always)]
    pub fn cmpen4(&mut self) -> Cmpen4W<'_, EmbCtl1Spec> {
        Cmpen4W::new(self, 3)
    }
    #[doc = "Bit 4 - desc SYSEN"]
    #[inline(always)]
    pub fn sysen(&mut self) -> SysenW<'_, EmbCtl1Spec> {
        SysenW::new(self, 4)
    }
    #[doc = "Bit 5 - desc PWMSEN0"]
    #[inline(always)]
    pub fn pwmsen0(&mut self) -> Pwmsen0W<'_, EmbCtl1Spec> {
        Pwmsen0W::new(self, 5)
    }
    #[doc = "Bit 6 - desc PWMSEN1"]
    #[inline(always)]
    pub fn pwmsen1(&mut self) -> Pwmsen1W<'_, EmbCtl1Spec> {
        Pwmsen1W::new(self, 6)
    }
    #[doc = "Bit 16 - desc PORTINEN1"]
    #[inline(always)]
    pub fn portinen1(&mut self) -> Portinen1W<'_, EmbCtl1Spec> {
        Portinen1W::new(self, 16)
    }
    #[doc = "Bit 17 - desc PORTINEN2"]
    #[inline(always)]
    pub fn portinen2(&mut self) -> Portinen2W<'_, EmbCtl1Spec> {
        Portinen2W::new(self, 17)
    }
    #[doc = "Bit 18 - desc PORTINEN3"]
    #[inline(always)]
    pub fn portinen3(&mut self) -> Portinen3W<'_, EmbCtl1Spec> {
        Portinen3W::new(self, 18)
    }
    #[doc = "Bit 19 - desc PORTINEN4"]
    #[inline(always)]
    pub fn portinen4(&mut self) -> Portinen4W<'_, EmbCtl1Spec> {
        Portinen4W::new(self, 19)
    }
    #[doc = "Bit 22 - desc INVSEL1"]
    #[inline(always)]
    pub fn invsel1(&mut self) -> Invsel1W<'_, EmbCtl1Spec> {
        Invsel1W::new(self, 22)
    }
    #[doc = "Bit 23 - desc INVSEL2"]
    #[inline(always)]
    pub fn invsel2(&mut self) -> Invsel2W<'_, EmbCtl1Spec> {
        Invsel2W::new(self, 23)
    }
    #[doc = "Bit 24 - desc INVSEL3"]
    #[inline(always)]
    pub fn invsel3(&mut self) -> Invsel3W<'_, EmbCtl1Spec> {
        Invsel3W::new(self, 24)
    }
    #[doc = "Bit 25 - desc INVSEL4"]
    #[inline(always)]
    pub fn invsel4(&mut self) -> Invsel4W<'_, EmbCtl1Spec> {
        Invsel4W::new(self, 25)
    }
    #[doc = "Bit 27 - desc OSCSTPEN"]
    #[inline(always)]
    pub fn oscstpen(&mut self) -> OscstpenW<'_, EmbCtl1Spec> {
        OscstpenW::new(self, 27)
    }
    #[doc = "Bit 28 - desc SRAMECCERREN"]
    #[inline(always)]
    pub fn srameccerren(&mut self) -> SrameccerrenW<'_, EmbCtl1Spec> {
        SrameccerrenW::new(self, 28)
    }
    #[doc = "Bit 29 - desc SRAMPYERREN"]
    #[inline(always)]
    pub fn srampyerren(&mut self) -> SrampyerrenW<'_, EmbCtl1Spec> {
        SrampyerrenW::new(self, 29)
    }
    #[doc = "Bit 30 - desc LOCKUPEN"]
    #[inline(always)]
    pub fn lockupen(&mut self) -> LockupenW<'_, EmbCtl1Spec> {
        LockupenW::new(self, 30)
    }
    #[doc = "Bit 31 - desc PVDEN"]
    #[inline(always)]
    pub fn pvden(&mut self) -> PvdenW<'_, EmbCtl1Spec> {
        PvdenW::new(self, 31)
    }
}
#[doc = "desc EMB_CTL1\n\nYou can [`read`](crate::Reg::read) this register and get [`emb_ctl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`emb_ctl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EmbCtl1Spec;
impl crate::RegisterSpec for EmbCtl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`emb_ctl1::R`](R) reader structure"]
impl crate::Readable for EmbCtl1Spec {}
#[doc = "`write(|w| ..)` method takes [`emb_ctl1::W`](W) writer structure"]
impl crate::Writable for EmbCtl1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EMB_CTL1 to value 0"]
impl crate::Resettable for EmbCtl1Spec {}
