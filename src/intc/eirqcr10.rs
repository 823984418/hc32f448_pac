#[doc = "Register `EIRQCR10` reader"]
pub type R = crate::R<Eirqcr10Spec>;
#[doc = "Register `EIRQCR10` writer"]
pub type W = crate::W<Eirqcr10Spec>;
...
impl W {
    #[doc = "Bits 0:1 - desc EIRQTRG"]
    #[inline(always)]
    pub fn eirqtrg(&mut self) -> EirqtrgW<'_, Eirqcr10Spec> {
        EirqtrgW::new(self, 0)
    }
    #[doc = "Bits 4:5 - desc EISMPCLK"]
    #[inline(always)]
    pub fn eismpclk(&mut self) -> EismpclkW<'_, Eirqcr10Spec> {
        EismpclkW::new(self, 4)
    }
    #[doc = "Bit 7 - desc EFEN"]
    #[inline(always)]
    pub fn efen(&mut self) -> EfenW<'_, Eirqcr10Spec> {
        EfenW::new(self, 7)
    }
    #[doc = "Bits 12:13 - desc NOCSEL"]
    #[inline(always)]
    pub fn nocsel(&mut self) -> NocselW<'_, Eirqcr10Spec> {
        NocselW::new(self, 12)
    }
    #[doc = "Bit 15 - desc NOCEN"]
    #[inline(always)]
    pub fn nocen(&mut self) -> NocenW<'_, Eirqcr10Spec> {
        NocenW::new(self, 15)
    }
}
#[doc = "desc EIRQCR10\n\nYou can [`read`](crate::Reg::read) this register and get [`eirqcr10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eirqcr10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eirqcr10Spec;
impl crate::RegisterSpec for Eirqcr10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eirqcr10::R`](R) reader structure"]
impl crate::Readable for Eirqcr10Spec {}
#[doc = "`write(|w| ..)` method takes [`eirqcr10::W`](W) writer structure"]
impl crate::Writable for Eirqcr10Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EIRQCR10 to value 0"]
impl crate::Resettable for Eirqcr10Spec {}
