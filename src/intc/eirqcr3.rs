#[doc = "Register `EIRQCR3` reader"]
pub type R = crate::R<Eirqcr3Spec>;
#[doc = "Register `EIRQCR3` writer"]
pub type W = crate::W<Eirqcr3Spec>;
...
impl W {
    #[doc = "Bits 0:1 - desc EIRQTRG"]
    #[inline(always)]
    pub fn eirqtrg(&mut self) -> EirqtrgW<'_, Eirqcr3Spec> {
        EirqtrgW::new(self, 0)
    }
    #[doc = "Bits 4:5 - desc EISMPCLK"]
    #[inline(always)]
    pub fn eismpclk(&mut self) -> EismpclkW<'_, Eirqcr3Spec> {
        EismpclkW::new(self, 4)
    }
    #[doc = "Bit 7 - desc EFEN"]
    #[inline(always)]
    pub fn efen(&mut self) -> EfenW<'_, Eirqcr3Spec> {
        EfenW::new(self, 7)
    }
    #[doc = "Bits 12:13 - desc NOCSEL"]
    #[inline(always)]
    pub fn nocsel(&mut self) -> NocselW<'_, Eirqcr3Spec> {
        NocselW::new(self, 12)
    }
    #[doc = "Bit 15 - desc NOCEN"]
    #[inline(always)]
    pub fn nocen(&mut self) -> NocenW<'_, Eirqcr3Spec> {
        NocenW::new(self, 15)
    }
}
#[doc = "desc EIRQCR3\n\nYou can [`read`](crate::Reg::read) this register and get [`eirqcr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eirqcr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eirqcr3Spec;
impl crate::RegisterSpec for Eirqcr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eirqcr3::R`](R) reader structure"]
impl crate::Readable for Eirqcr3Spec {}
#[doc = "`write(|w| ..)` method takes [`eirqcr3::W`](W) writer structure"]
impl crate::Writable for Eirqcr3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EIRQCR3 to value 0"]
impl crate::Resettable for Eirqcr3Spec {}
