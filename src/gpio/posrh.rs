...
impl W {
    ...
    #[doc = "Bit 3 - desc POS03"]
    #[inline(always)]
    pub fn pos03(&mut self) -> Pos03W<'_, PosrhSpec> {
        Pos03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POS04"]
    #[inline(always)]
    pub fn pos04(&mut self) -> Pos04W<'_, PosrhSpec> {
        Pos04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POS05"]
    #[inline(always)]
    pub fn pos05(&mut self) -> Pos05W<'_, PosrhSpec> {
        Pos05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POS06"]
    #[inline(always)]
    pub fn pos06(&mut self) -> Pos06W<'_, PosrhSpec> {
        Pos06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POS07"]
    #[inline(always)]
    pub fn pos07(&mut self) -> Pos07W<'_, PosrhSpec> {
        Pos07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POS08"]
    #[inline(always)]
    pub fn pos08(&mut self) -> Pos08W<'_, PosrhSpec> {
        Pos08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POS09"]
    #[inline(always)]
    pub fn pos09(&mut self) -> Pos09W<'_, PosrhSpec> {
        Pos09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POS10"]
    #[inline(always)]
    pub fn pos10(&mut self) -> Pos10W<'_, PosrhSpec> {
        Pos10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POS11"]
    #[inline(always)]
    pub fn pos11(&mut self) -> Pos11W<'_, PosrhSpec> {
        Pos11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POS12"]
    #[inline(always)]
    pub fn pos12(&mut self) -> Pos12W<'_, PosrhSpec> {
        Pos12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POS13"]
    #[inline(always)]
    pub fn pos13(&mut self) -> Pos13W<'_, PosrhSpec> {
        Pos13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POS14"]
    #[inline(always)]
    pub fn pos14(&mut self) -> Pos14W<'_, PosrhSpec> {
        Pos14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POS15"]
    #[inline(always)]
    pub fn pos15(&mut self) -> Pos15W<'_, PosrhSpec> {
        Pos15W::new(self, 15)
    }
}
