...
impl W {
    #[doc = "Bit 0 - desc POT00"]
    #[inline(always)]
    pub fn pot00(&mut self) -> Pot00W<'_, PotrcSpec> {
        Pot00W::new(self, 0)
    }
    #[doc = "Bit 1 - desc POT01"]
    #[inline(always)]
    pub fn pot01(&mut self) -> Pot01W<'_, PotrcSpec> {
        Pot01W::new(self, 1)
    }
    #[doc = "Bit 2 - desc POT02"]
    #[inline(always)]
    pub fn pot02(&mut self) -> Pot02W<'_, PotrcSpec> {
        Pot02W::new(self, 2)
    }
    #[doc = "Bit 3 - desc POT03"]
    #[inline(always)]
    pub fn pot03(&mut self) -> Pot03W<'_, PotrcSpec> {
        Pot03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POT04"]
    #[inline(always)]
    pub fn pot04(&mut self) -> Pot04W<'_, PotrcSpec> {
        Pot04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POT05"]
    #[inline(always)]
    pub fn pot05(&mut self) -> Pot05W<'_, PotrcSpec> {
        Pot05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POT06"]
    #[inline(always)]
    pub fn pot06(&mut self) -> Pot06W<'_, PotrcSpec> {
        Pot06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POT07"]
    #[inline(always)]
    pub fn pot07(&mut self) -> Pot07W<'_, PotrcSpec> {
        Pot07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POT08"]
    #[inline(always)]
    pub fn pot08(&mut self) -> Pot08W<'_, PotrcSpec> {
        Pot08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POT09"]
    #[inline(always)]
    pub fn pot09(&mut self) -> Pot09W<'_, PotrcSpec> {
        Pot09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POT10"]
    #[inline(always)]
    pub fn pot10(&mut self) -> Pot10W<'_, PotrcSpec> {
        Pot10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POT11"]
    #[inline(always)]
    pub fn pot11(&mut self) -> Pot11W<'_, PotrcSpec> {
        Pot11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POT12"]
    #[inline(always)]
    pub fn pot12(&mut self) -> Pot12W<'_, PotrcSpec> {
        Pot12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POT13"]
    #[inline(always)]
