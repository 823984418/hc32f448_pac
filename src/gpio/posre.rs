#[doc = "Register `POSRE` reader"]
pub type R = crate::R<PosreSpec>;
#[doc = "Register `POSRE` writer"]
pub type W = crate::W<PosreSpec>;
...
impl W {
    #[doc = "Bit 0 - desc POS00"]
    #[inline(always)]
    pub fn pos00(&mut self) -> Pos00W<'_, PosreSpec> {
        Pos00W::new(self, 0)
    }
    #[doc = "Bit 1 - desc POS01"]
    #[inline(always)]
    pub fn pos01(&mut self) -> Pos01W<'_, PosreSpec> {
        Pos01W::new(self, 1)
    }
    #[doc = "Bit 2 - desc POS02"]
    #[inline(always)]
    pub fn pos02(&mut self) -> Pos02W<'_, PosreSpec> {
        Pos02W::new(self, 2)
    }
    #[doc = "Bit 3 - desc POS03"]
    #[inline(always)]
    pub fn pos03(&mut self) -> Pos03W<'_, PosreSpec> {
        Pos03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POS04"]
    #[inline(always)]
    pub fn pos04(&mut self) -> Pos04W<'_, PosreSpec> {
        Pos04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POS05"]
    #[inline(always)]
    pub fn pos05(&mut self) -> Pos05W<'_, PosreSpec> {
        Pos05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POS06"]
    #[inline(always)]
    pub fn pos06(&mut self) -> Pos06W<'_, PosreSpec> {
        Pos06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POS07"]
    #[inline(always)]
    pub fn pos07(&mut self) -> Pos07W<'_, PosreSpec> {
        Pos07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POS08"]
    #[inline(always)]
    pub fn pos08(&mut self) -> Pos08W<'_, PosreSpec> {
        Pos08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POS09"]
    #[inline(always)]
    pub fn pos09(&mut self) -> Pos09W<'_, PosreSpec> {
        Pos09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POS10"]
    #[inline(always)]
    pub fn pos10(&mut self) -> Pos10W<'_, PosreSpec> {
        Pos10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POS11"]
    #[inline(always)]
    pub fn pos11(&mut self) -> Pos11W<'_, PosreSpec> {
        Pos11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POS12"]
    #[inline(always)]
    pub fn pos12(&mut self) -> Pos12W<'_, PosreSpec> {
        Pos12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POS13"]
    #[inline(always)]
    pub fn pos13(&mut self) -> Pos13W<'_, PosreSpec> {
        Pos13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POS14"]
    #[inline(always)]
    pub fn pos14(&mut self) -> Pos14W<'_, PosreSpec> {
        Pos14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POS15"]
    #[inline(always)]
    pub fn pos15(&mut self) -> Pos15W<'_, PosreSpec> {
        Pos15W::new(self, 15)
    }
}
#[doc = "desc POSRE\n\nYou can [`read`](crate::Reg::read) this register and get [`posre::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`posre::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PosreSpec;
impl crate::RegisterSpec for PosreSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`posre::R`](R) reader structure"]
impl crate::Readable for PosreSpec {}
#[doc = "`write(|w| ..)` method takes [`posre::W`](W) writer structure"]
impl crate::Writable for PosreSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets POSRE to value 0"]
impl crate::Resettable for PosreSpec {}
