#[doc = "Register `PCRB11` reader"]
pub type R = crate::R<Pcrb11Spec>;
#[doc = "Register `PCRB11` writer"]
pub type W = crate::W<Pcrb11Spec>;
...
impl W {
    #[doc = "Bit 0 - desc POUT"]
    #[inline(always)]
    pub fn pout(&mut self) -> PoutW<'_, Pcrb11Spec> {
        PoutW::new(self, 0)
    }
    #[doc = "Bit 1 - desc POUTE"]
    #[inline(always)]
    pub fn poute(&mut self) -> PouteW<'_, Pcrb11Spec> {
        PouteW::new(self, 1)
    }
    #[doc = "Bit 2 - desc NOD"]
    #[inline(always)]
    pub fn nod(&mut self) -> NodW<'_, Pcrb11Spec> {
        NodW::new(self, 2)
    }
    #[doc = "Bits 4:5 - desc DRV"]
    #[inline(always)]
    pub fn drv(&mut self) -> DrvW<'_, Pcrb11Spec> {
        DrvW::new(self, 4)
    }
    #[doc = "Bit 6 - desc PUU"]
    #[inline(always)]
    pub fn puu(&mut self) -> PuuW<'_, Pcrb11Spec> {
        PuuW::new(self, 6)
    }
    #[doc = "Bit 7 - desc PUD"]
    #[inline(always)]
    pub fn pud(&mut self) -> PudW<'_, Pcrb11Spec> {
        PudW::new(self, 7)
    }
    #[doc = "Bit 9 - desc INVE"]
    #[inline(always)]
    pub fn inve(&mut self) -> InveW<'_, Pcrb11Spec> {
        InveW::new(self, 9)
    }
    #[doc = "Bit 10 - desc CINSEL"]
    #[inline(always)]
    pub fn cinsel(&mut self) -> CinselW<'_, Pcrb11Spec> {
        CinselW::new(self, 10)
    }
    #[doc = "Bit 12 - desc INTE"]
    #[inline(always)]
    pub fn inte(&mut self) -> InteW<'_, Pcrb11Spec> {
        InteW::new(self, 12)
    }
    #[doc = "Bit 13 - desc PINAE"]
    #[inline(always)]
    pub fn pinae(&mut self) -> PinaeW<'_, Pcrb11Spec> {
        PinaeW::new(self, 13)
    }
    #[doc = "Bit 14 - desc LTE"]
    #[inline(always)]
    pub fn lte(&mut self) -> LteW<'_, Pcrb11Spec> {
        LteW::new(self, 14)
    }
    #[doc = "Bit 15 - desc DDIS"]
    #[inline(always)]
    pub fn ddis(&mut self) -> DdisW<'_, Pcrb11Spec> {
        DdisW::new(self, 15)
    }
}
#[doc = "desc PCRB11\n\nYou can [`read`](crate::Reg::read) this register and get [`pcrb11::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcrb11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pcrb11Spec;
impl crate::RegisterSpec for Pcrb11Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pcrb11::R`](R) reader structure"]
impl crate::Readable for Pcrb11Spec {}
#[doc = "`write(|w| ..)` method takes [`pcrb11::W`](W) writer structure"]
impl crate::Writable for Pcrb11Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PCRB11 to value 0"]
impl crate::Resettable for Pcrb11Spec {}
