...
impl W {
    ...
    #[doc = "Bit 3 - desc POUT03"]
    #[inline(always)]
    pub fn pout03(&mut self) -> Pout03W<'_, PodrhSpec> {
        Pout03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POUT04"]
    #[inline(always)]
    pub fn pout04(&mut self) -> Pout04W<'_, PodrhSpec> {
        Pout04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POUT05"]
    #[inline(always)]
    pub fn pout05(&mut self) -> Pout05W<'_, PodrhSpec> {
        Pout05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POUT06"]
    #[inline(always)]
    pub fn pout06(&mut self) -> Pout06W<'_, PodrhSpec> {
        Pout06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POUT07"]
    #[inline(always)]
    pub fn pout07(&mut self) -> Pout07W<'_, PodrhSpec> {
        Pout07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POUT08"]
    #[inline(always)]
    pub fn pout08(&mut self) -> Pout08W<'_, PodrhSpec> {
        Pout08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POUT09"]
    #[inline(always)]
    pub fn pout09(&mut self) -> Pout09W<'_, PodrhSpec> {
        Pout09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POUT10"]
    #[inline(always)]
    pub fn pout10(&mut self) -> Pout10W<'_, PodrhSpec> {
        Pout10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POUT11"]
    #[inline(always)]
    pub fn pout11(&mut self) -> Pout11W<'_, PodrhSpec> {
        Pout11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POUT12"]
    #[inline(always)]
    pub fn pout12(&mut self) -> Pout12W<'_, PodrhSpec> {
        Pout12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POUT13"]
    #[inline(always)]
    pub fn pout13(&mut self) -> Pout13W<'_, PodrhSpec> {
        Pout13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POUT14"]
    #[inline(always)]
    pub fn pout14(&mut self) -> Pout14W<'_, PodrhSpec> {
        Pout14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POUT15"]
    #[inline(always)]
    pub fn pout15(&mut self) -> Pout15W<'_, PodrhSpec> {
        Pout15W::new(self, 15)
    }
}
