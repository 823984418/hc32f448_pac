#[doc = "Register `POSRA` reader"]
pub type R = crate::R<PosraSpec>;
#[doc = "Register `POSRA` writer"]
pub type W = crate::W<PosraSpec>;
...
impl W {
    #[doc = "Bit 0 - desc POS00"]
    #[inline(always)]
    pub fn pos00(&mut self) -> Pos00W<'_, PosraSpec> {
        Pos00W::new(self, 0)
    }
    #[doc = "Bit 1 - desc POS01"]
    #[inline(always)]
    pub fn pos01(&mut self) -> Pos01W<'_, PosraSpec> {
        Pos01W::new(self, 1)
    }
    #[doc = "Bit 2 - desc POS02"]
    #[inline(always)]
    pub fn pos02(&mut self) -> Pos02W<'_, PosraSpec> {
        Pos02W::new(self, 2)
    }
    #[doc = "Bit 3 - desc POS03"]
    #[inline(always)]
    pub fn pos03(&mut self) -> Pos03W<'_, PosraSpec> {
        Pos03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POS04"]
    #[inline(always)]
    pub fn pos04(&mut self) -> Pos04W<'_, PosraSpec> {
        Pos04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POS05"]
    #[inline(always)]
    pub fn pos05(&mut self) -> Pos05W<'_, PosraSpec> {
        Pos05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POS06"]
    #[inline(always)]
    pub fn pos06(&mut self) -> Pos06W<'_, PosraSpec> {
        Pos06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POS07"]
    #[inline(always)]
    pub fn pos07(&mut self) -> Pos07W<'_, PosraSpec> {
        Pos07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POS08"]
    #[inline(always)]
    pub fn pos08(&mut self) -> Pos08W<'_, PosraSpec> {
        Pos08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POS09"]
    #[inline(always)]
    pub fn pos09(&mut self) -> Pos09W<'_, PosraSpec> {
        Pos09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POS10"]
    #[inline(always)]
    pub fn pos10(&mut self) -> Pos10W<'_, PosraSpec> {
        Pos10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POS11"]
    #[inline(always)]
    pub fn pos11(&mut self) -> Pos11W<'_, PosraSpec> {
        Pos11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POS12"]
    #[inline(always)]
    pub fn pos12(&mut self) -> Pos12W<'_, PosraSpec> {
        Pos12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POS13"]
    #[inline(always)]
    pub fn pos13(&mut self) -> Pos13W<'_, PosraSpec> {
        Pos13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POS14"]
    #[inline(always)]
    pub fn pos14(&mut self) -> Pos14W<'_, PosraSpec> {
        Pos14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POS15"]
    #[inline(always)]
    pub fn pos15(&mut self) -> Pos15W<'_, PosraSpec> {
        Pos15W::new(self, 15)
    }
}
#[doc = "desc POSRA\n\nYou can [`read`](crate::Reg::read) this register and get [`posra::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`posra::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PosraSpec;
impl crate::RegisterSpec for PosraSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`posra::R`](R) reader structure"]
impl crate::Readable for PosraSpec {}
#[doc = "`write(|w| ..)` method takes [`posra::W`](W) writer structure"]
impl crate::Writable for PosraSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets POSRA to value 0"]
impl crate::Resettable for PosraSpec {}
