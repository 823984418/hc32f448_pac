...
impl W {
    #[doc = "Bit 0 - desc POUT00"]
    #[inline(always)]
    pub fn pout00(&mut self) -> Pout00W<'_, PodrcSpec> {
        Pout00W::new(self, 0)
    }
    #[doc = "Bit 1 - desc POUT01"]
    #[inline(always)]
    pub fn pout01(&mut self) -> Pout01W<'_, PodrcSpec> {
        Pout01W::new(self, 1)
    }
    #[doc = "Bit 2 - desc POUT02"]
    #[inline(always)]
    pub fn pout02(&mut self) -> Pout02W<'_, PodrcSpec> {
        Pout02W::new(self, 2)
    }
    #[doc = "Bit 3 - desc POUT03"]
    #[inline(always)]
    pub fn pout03(&mut self) -> Pout03W<'_, PodrcSpec> {
        Pout03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POUT04"]
    #[inline(always)]
    pub fn pout04(&mut self) -> Pout04W<'_, PodrcSpec> {
        Pout04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POUT05"]
    #[inline(always)]
    pub fn pout05(&mut self) -> Pout05W<'_, PodrcSpec> {
        Pout05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POUT06"]
    #[inline(always)]
    pub fn pout06(&mut self) -> Pout06W<'_, PodrcSpec> {
        Pout06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POUT07"]
    #[inline(always)]
    pub fn pout07(&mut self) -> Pout07W<'_, PodrcSpec> {
        Pout07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POUT08"]
    #[inline(always)]
    pub fn pout08(&mut self) -> Pout08W<'_, PodrcSpec> {
        Pout08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POUT09"]
    #[inline(always)]
    pub fn pout09(&mut self) -> Pout09W<'_, PodrcSpec> {
        Pout09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POUT10"]
    #[inline(always)]
    pub fn pout10(&mut self) -> Pout10W<'_, PodrcSpec> {
        Pout10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POUT11"]
    #[inline(always)]
    pub fn pout11(&mut self) -> Pout11W<'_, PodrcSpec> {
        Pout11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POUT12"]
    #[inline(always)]
    pub fn pout12(&mut self) -> Pout12W<'_, PodrcSpec> {
        Pout12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POUT13"]
    #[inline(always)]
