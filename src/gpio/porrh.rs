...
impl W {
    ...
    #[doc = "Bit 3 - desc POR03"]
    #[inline(always)]
    pub fn por03(&mut self) -> Por03W<'_, PorrhSpec> {
        Por03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POR04"]
    #[inline(always)]
    pub fn por04(&mut self) -> Por04W<'_, PorrhSpec> {
        Por04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POR05"]
    #[inline(always)]
    pub fn por05(&mut self) -> Por05W<'_, PorrhSpec> {
        Por05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POR06"]
    #[inline(always)]
    pub fn por06(&mut self) -> Por06W<'_, PorrhSpec> {
        Por06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POR07"]
    #[inline(always)]
    pub fn por07(&mut self) -> Por07W<'_, PorrhSpec> {
        Por07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POR08"]
    #[inline(always)]
    pub fn por08(&mut self) -> Por08W<'_, PorrhSpec> {
        Por08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POR09"]
    #[inline(always)]
    pub fn por09(&mut self) -> Por09W<'_, PorrhSpec> {
        Por09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POR10"]
    #[inline(always)]
    pub fn por10(&mut self) -> Por10W<'_, PorrhSpec> {
        Por10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POR11"]
    #[inline(always)]
    pub fn por11(&mut self) -> Por11W<'_, PorrhSpec> {
        Por11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POR12"]
    #[inline(always)]
    pub fn por12(&mut self) -> Por12W<'_, PorrhSpec> {
        Por12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POR13"]
    #[inline(always)]
    pub fn por13(&mut self) -> Por13W<'_, PorrhSpec> {
        Por13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POR14"]
    #[inline(always)]
    pub fn por14(&mut self) -> Por14W<'_, PorrhSpec> {
        Por14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POR15"]
    #[inline(always)]
    pub fn por15(&mut self) -> Por15W<'_, PorrhSpec> {
        Por15W::new(self, 15)
    }
}
