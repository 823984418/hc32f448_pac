#[doc = "Register `PIDRD` reader"]
pub type R = crate::R<PidrdSpec>;
...
#[doc = "desc PIDRD\n\nYou can [`read`](crate::Reg::read) this register and get [`pidrd::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PidrdSpec;
impl crate::RegisterSpec for PidrdSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pidrd::R`](R) reader structure"]
impl crate::Readable for PidrdSpec {}
#[doc = "`reset()` method sets PIDRD to value 0"]
impl crate::Resettable for PidrdSpec {}
