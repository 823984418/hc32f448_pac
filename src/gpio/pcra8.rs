#[doc = "Register `PCRA8` reader"]
pub type R = crate::R<Pcra8Spec>;
#[doc = "Register `PCRA8` writer"]
pub type W = crate::W<Pcra8Spec>;
...
impl W {
    #[doc = "Bit 0 - desc POUT"]
    #[inline(always)]
    pub fn pout(&mut self) -> PoutW<'_, Pcra8Spec> {
        PoutW::new(self, 0)
    }
    #[doc = "Bit 1 - desc POUTE"]
    #[inline(always)]
    pub fn poute(&mut self) -> PouteW<'_, Pcra8Spec> {
        PouteW::new(self, 1)
    }
    #[doc = "Bit 2 - desc NOD"]
    #[inline(always)]
    pub fn nod(&mut self) -> NodW<'_, Pcra8Spec> {
        NodW::new(self, 2)
    }
    #[doc = "Bits 4:5 - desc DRV"]
    #[inline(always)]
    pub fn drv(&mut self) -> DrvW<'_, Pcra8Spec> {
        DrvW::new(self, 4)
    }
    #[doc = "Bit 6 - desc PUU"]
    #[inline(always)]
    pub fn puu(&mut self) -> PuuW<'_, Pcra8Spec> {
        PuuW::new(self, 6)
    }
    #[doc = "Bit 7 - desc PUD"]
    #[inline(always)]
    pub fn pud(&mut self) -> PudW<'_, Pcra8Spec> {
        PudW::new(self, 7)
    }
    #[doc = "Bit 9 - desc INVE"]
    #[inline(always)]
    pub fn inve(&mut self) -> InveW<'_, Pcra8Spec> {
        InveW::new(self, 9)
    }
    #[doc = "Bit 10 - desc CINSEL"]
    #[inline(always)]
    pub fn cinsel(&mut self) -> CinselW<'_, Pcra8Spec> {
        CinselW::new(self, 10)
    }
    #[doc = "Bit 12 - desc INTE"]
    #[inline(always)]
    pub fn inte(&mut self) -> InteW<'_, Pcra8Spec> {
        InteW::new(self, 12)
    }
    #[doc = "Bit 13 - desc PINAE"]
    #[inline(always)]
    pub fn pinae(&mut self) -> PinaeW<'_, Pcra8Spec> {
        PinaeW::new(self, 13)
    }
    #[doc = "Bit 14 - desc LTE"]
    #[inline(always)]
    pub fn lte(&mut self) -> LteW<'_, Pcra8Spec> {
        LteW::new(self, 14)
    }
    #[doc = "Bit 15 - desc DDIS"]
    #[inline(always)]
    pub fn ddis(&mut self) -> DdisW<'_, Pcra8Spec> {
        DdisW::new(self, 15)
    }
}
#[doc = "desc PCRA8\n\nYou can [`read`](crate::Reg::read) this register and get [`pcra8::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcra8::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pcra8Spec;
impl crate::RegisterSpec for Pcra8Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pcra8::R`](R) reader structure"]
impl crate::Readable for Pcra8Spec {}
#[doc = "`write(|w| ..)` method takes [`pcra8::W`](W) writer structure"]
impl crate::Writable for Pcra8Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PCRA8 to value 0"]
impl crate::Resettable for Pcra8Spec {}
