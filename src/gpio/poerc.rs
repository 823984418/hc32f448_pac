...
impl W {
    #[doc = "Bit 0 - desc POUTE00"]
    #[inline(always)]
    pub fn poute00(&mut self) -> Poute00W<'_, PoercSpec> {
        Poute00W::new(self, 0)
    }
    #[doc = "Bit 1 - desc POUTE01"]
    #[inline(always)]
    pub fn poute01(&mut self) -> Poute01W<'_, PoercSpec> {
        Poute01W::new(self, 1)
    }
    #[doc = "Bit 2 - desc POUTE02"]
    #[inline(always)]
    pub fn poute02(&mut self) -> Poute02W<'_, PoercSpec> {
        Poute02W::new(self, 2)
    }
    #[doc = "Bit 3 - desc POUTE03"]
    #[inline(always)]
    pub fn poute03(&mut self) -> Poute03W<'_, PoercSpec> {
        Poute03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POUTE04"]
    #[inline(always)]
    pub fn poute04(&mut self) -> Poute04W<'_, PoercSpec> {
        Poute04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POUTE05"]
    #[inline(always)]
    pub fn poute05(&mut self) -> Poute05W<'_, PoercSpec> {
        Poute05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POUTE06"]
    #[inline(always)]
    pub fn poute06(&mut self) -> Poute06W<'_, PoercSpec> {
        Poute06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POUTE07"]
    #[inline(always)]
    pub fn poute07(&mut self) -> Poute07W<'_, PoercSpec> {
        Poute07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POUTE08"]
    #[inline(always)]
    pub fn poute08(&mut self) -> Poute08W<'_, PoercSpec> {
        Poute08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POUTE09"]
    #[inline(always)]
    pub fn poute09(&mut self) -> Poute09W<'_, PoercSpec> {
        Poute09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POUTE10"]
    #[inline(always)]
    pub fn poute10(&mut self) -> Poute10W<'_, PoercSpec> {
        Poute10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POUTE11"]
    #[inline(always)]
    pub fn poute11(&mut self) -> Poute11W<'_, PoercSpec> {
        Poute11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POUTE12"]
    #[inline(always)]
    pub fn poute12(&mut self) -> Poute12W<'_, PoercSpec> {
