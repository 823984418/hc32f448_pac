#[doc = "Register `PCRD2` reader"]
pub type R = crate::R<Pcrd2Spec>;
#[doc = "Register `PCRD2` writer"]
pub type W = crate::W<Pcrd2Spec>;
...
impl W {
    #[doc = "Bit 0 - desc POUT"]
    #[inline(always)]
    pub fn pout(&mut self) -> PoutW<'_, Pcrd2Spec> {
        PoutW::new(self, 0)
    }
    #[doc = "Bit 1 - desc POUTE"]
    #[inline(always)]
    pub fn poute(&mut self) -> PouteW<'_, Pcrd2Spec> {
        PouteW::new(self, 1)
    }
    #[doc = "Bit 2 - desc NOD"]
    #[inline(always)]
    pub fn nod(&mut self) -> NodW<'_, Pcrd2Spec> {
        NodW::new(self, 2)
    }
    #[doc = "Bits 4:5 - desc DRV"]
    #[inline(always)]
    pub fn drv(&mut self) -> DrvW<'_, Pcrd2Spec> {
        DrvW::new(self, 4)
    }
    #[doc = "Bit 6 - desc PUU"]
    #[inline(always)]
    pub fn puu(&mut self) -> PuuW<'_, Pcrd2Spec> {
        PuuW::new(self, 6)
    }
    #[doc = "Bit 7 - desc PUD"]
    #[inline(always)]
    pub fn pud(&mut self) -> PudW<'_, Pcrd2Spec> {
        PudW::new(self, 7)
    }
    #[doc = "Bit 9 - desc INVE"]
    #[inline(always)]
    pub fn inve(&mut self) -> InveW<'_, Pcrd2Spec> {
        InveW::new(self, 9)
    }
    #[doc = "Bit 10 - desc CINSEL"]
    #[inline(always)]
    pub fn cinsel(&mut self) -> CinselW<'_, Pcrd2Spec> {
        CinselW::new(self, 10)
    }
    #[doc = "Bit 12 - desc INTE"]
    #[inline(always)]
    pub fn inte(&mut self) -> InteW<'_, Pcrd2Spec> {
        InteW::new(self, 12)
    }
    #[doc = "Bit 13 - desc PINAE"]
    #[inline(always)]
    pub fn pinae(&mut self) -> PinaeW<'_, Pcrd2Spec> {
        PinaeW::new(self, 13)
    }
    #[doc = "Bit 14 - desc LTE"]
    #[inline(always)]
    pub fn lte(&mut self) -> LteW<'_, Pcrd2Spec> {
        LteW::new(self, 14)
    }
    #[doc = "Bit 15 - desc DDIS"]
    #[inline(always)]
    pub fn ddis(&mut self) -> DdisW<'_, Pcrd2Spec> {
        DdisW::new(self, 15)
    }
}
#[doc = "desc PCRD2\n\nYou can [`read`](crate::Reg::read) this register and get [`pcrd2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcrd2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pcrd2Spec;
impl crate::RegisterSpec for Pcrd2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pcrd2::R`](R) reader structure"]
impl crate::Readable for Pcrd2Spec {}
#[doc = "`write(|w| ..)` method takes [`pcrd2::W`](W) writer structure"]
impl crate::Writable for Pcrd2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PCRD2 to value 0"]
impl crate::Resettable for Pcrd2Spec {}
