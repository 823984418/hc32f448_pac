#[doc = "Register `POERA` reader"]
pub type R = crate::R<PoeraSpec>;
#[doc = "Register `POERA` writer"]
pub type W = crate::W<PoeraSpec>;
...
impl W {
    #[doc = "Bit 0 - desc POUTE00"]
    #[inline(always)]
    pub fn poute00(&mut self) -> Poute00W<'_, PoeraSpec> {
        Poute00W::new(self, 0)
    }
    #[doc = "Bit 1 - desc POUTE01"]
    #[inline(always)]
    pub fn poute01(&mut self) -> Poute01W<'_, PoeraSpec> {
        Poute01W::new(self, 1)
    }
    #[doc = "Bit 2 - desc POUTE02"]
    #[inline(always)]
    pub fn poute02(&mut self) -> Poute02W<'_, PoeraSpec> {
        Poute02W::new(self, 2)
    }
    #[doc = "Bit 3 - desc POUTE03"]
    #[inline(always)]
    pub fn poute03(&mut self) -> Poute03W<'_, PoeraSpec> {
        Poute03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POUTE04"]
    #[inline(always)]
    pub fn poute04(&mut self) -> Poute04W<'_, PoeraSpec> {
        Poute04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POUTE05"]
    #[inline(always)]
    pub fn poute05(&mut self) -> Poute05W<'_, PoeraSpec> {
        Poute05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POUTE06"]
    #[inline(always)]
    pub fn poute06(&mut self) -> Poute06W<'_, PoeraSpec> {
        Poute06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POUTE07"]
    #[inline(always)]
    pub fn poute07(&mut self) -> Poute07W<'_, PoeraSpec> {
        Poute07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POUTE08"]
    #[inline(always)]
    pub fn poute08(&mut self) -> Poute08W<'_, PoeraSpec> {
        Poute08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POUTE09"]
    #[inline(always)]
    pub fn poute09(&mut self) -> Poute09W<'_, PoeraSpec> {
        Poute09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POUTE10"]
    #[inline(always)]
    pub fn poute10(&mut self) -> Poute10W<'_, PoeraSpec> {
        Poute10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POUTE11"]
    #[inline(always)]
    pub fn poute11(&mut self) -> Poute11W<'_, PoeraSpec> {
        Poute11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POUTE12"]
    #[inline(always)]
    pub fn poute12(&mut self) -> Poute12W<'_, PoeraSpec> {
        Poute12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POUTE13"]
    #[inline(always)]
    pub fn poute13(&mut self) -> Poute13W<'_, PoeraSpec> {
        Poute13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POUTE14"]
    #[inline(always)]
    pub fn poute14(&mut self) -> Poute14W<'_, PoeraSpec> {
        Poute14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POUTE15"]
    #[inline(always)]
    pub fn poute15(&mut self) -> Poute15W<'_, PoeraSpec> {
        Poute15W::new(self, 15)
    }
}
#[doc = "desc POERA\n\nYou can [`read`](crate::Reg::read) this register and get [`poera::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`poera::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PoeraSpec;
impl crate::RegisterSpec for PoeraSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`poera::R`](R) reader structure"]
impl crate::Readable for PoeraSpec {}
#[doc = "`write(|w| ..)` method takes [`poera::W`](W) writer structure"]
impl crate::Writable for PoeraSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets POERA to value 0"]
impl crate::Resettable for PoeraSpec {}
