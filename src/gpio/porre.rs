#[doc = "Register `PORRE` reader"]
pub type R = crate::R<PorreSpec>;
#[doc = "Register `PORRE` writer"]
pub type W = crate::W<PorreSpec>;
...
impl W {
    #[doc = "Bit 0 - desc POR00"]
    #[inline(always)]
    pub fn por00(&mut self) -> Por00W<'_, PorreSpec> {
        Por00W::new(self, 0)
    }
    #[doc = "Bit 1 - desc POR01"]
    #[inline(always)]
    pub fn por01(&mut self) -> Por01W<'_, PorreSpec> {
        Por01W::new(self, 1)
    }
    #[doc = "Bit 2 - desc POR02"]
    #[inline(always)]
    pub fn por02(&mut self) -> Por02W<'_, PorreSpec> {
        Por02W::new(self, 2)
    }
    #[doc = "Bit 3 - desc POR03"]
    #[inline(always)]
    pub fn por03(&mut self) -> Por03W<'_, PorreSpec> {
        Por03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POR04"]
    #[inline(always)]
    pub fn por04(&mut self) -> Por04W<'_, PorreSpec> {
        Por04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POR05"]
    #[inline(always)]
    pub fn por05(&mut self) -> Por05W<'_, PorreSpec> {
        Por05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POR06"]
    #[inline(always)]
    pub fn por06(&mut self) -> Por06W<'_, PorreSpec> {
        Por06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POR07"]
    #[inline(always)]
    pub fn por07(&mut self) -> Por07W<'_, PorreSpec> {
        Por07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POR08"]
    #[inline(always)]
    pub fn por08(&mut self) -> Por08W<'_, PorreSpec> {
        Por08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POR09"]
    #[inline(always)]
    pub fn por09(&mut self) -> Por09W<'_, PorreSpec> {
        Por09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POR10"]
    #[inline(always)]
    pub fn por10(&mut self) -> Por10W<'_, PorreSpec> {
        Por10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POR11"]
    #[inline(always)]
    pub fn por11(&mut self) -> Por11W<'_, PorreSpec> {
        Por11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POR12"]
    #[inline(always)]
    pub fn por12(&mut self) -> Por12W<'_, PorreSpec> {
        Por12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POR13"]
    #[inline(always)]
    pub fn por13(&mut self) -> Por13W<'_, PorreSpec> {
        Por13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POR14"]
    #[inline(always)]
    pub fn por14(&mut self) -> Por14W<'_, PorreSpec> {
        Por14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POR15"]
    #[inline(always)]
    pub fn por15(&mut self) -> Por15W<'_, PorreSpec> {
        Por15W::new(self, 15)
    }
}
#[doc = "desc PORRE\n\nYou can [`read`](crate::Reg::read) this register and get [`porre::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`porre::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PorreSpec;
impl crate::RegisterSpec for PorreSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`porre::R`](R) reader structure"]
impl crate::Readable for PorreSpec {}
#[doc = "`write(|w| ..)` method takes [`porre::W`](W) writer structure"]
impl crate::Writable for PorreSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PORRE to value 0"]
impl crate::Resettable for PorreSpec {}
