...
impl W {
    ...
    #[doc = "Bit 3 - desc POT03"]
    #[inline(always)]
    pub fn pot03(&mut self) -> Pot03W<'_, PotrhSpec> {
        Pot03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POT04"]
    #[inline(always)]
    pub fn pot04(&mut self) -> Pot04W<'_, PotrhSpec> {
        Pot04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POT05"]
    #[inline(always)]
    pub fn pot05(&mut self) -> Pot05W<'_, PotrhSpec> {
        Pot05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POT06"]
    #[inline(always)]
    pub fn pot06(&mut self) -> Pot06W<'_, PotrhSpec> {
        Pot06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POT07"]
    #[inline(always)]
    pub fn pot07(&mut self) -> Pot07W<'_, PotrhSpec> {
        Pot07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POT08"]
    #[inline(always)]
    pub fn pot08(&mut self) -> Pot08W<'_, PotrhSpec> {
        Pot08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POT09"]
    #[inline(always)]
    pub fn pot09(&mut self) -> Pot09W<'_, PotrhSpec> {
        Pot09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POT10"]
    #[inline(always)]
    pub fn pot10(&mut self) -> Pot10W<'_, PotrhSpec> {
        Pot10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POT11"]
    #[inline(always)]
    pub fn pot11(&mut self) -> Pot11W<'_, PotrhSpec> {
        Pot11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POT12"]
    #[inline(always)]
    pub fn pot12(&mut self) -> Pot12W<'_, PotrhSpec> {
        Pot12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POT13"]
    #[inline(always)]
    pub fn pot13(&mut self) -> Pot13W<'_, PotrhSpec> {
        Pot13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POT14"]
    #[inline(always)]
    pub fn pot14(&mut self) -> Pot14W<'_, PotrhSpec> {
        Pot14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POT15"]
    #[inline(always)]
    pub fn pot15(&mut self) -> Pot15W<'_, PotrhSpec> {
        Pot15W::new(self, 15)
    }
}
