#[doc = "Register `PIDRC` reader"]
pub type R = crate::R<PidrcSpec>;
...
#[doc = "desc PIDRC\n\nYou can [`read`](crate::Reg::read) this register and get [`pidrc::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PidrcSpec;
impl crate::RegisterSpec for PidrcSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pidrc::R`](R) reader structure"]
impl crate::Readable for PidrcSpec {}
#[doc = "`reset()` method sets PIDRC to value 0"]
impl crate::Resettable for PidrcSpec {}
