#[doc = "Register `PIDRB` reader"]
pub type R = crate::R<PidrbSpec>;
...
#[doc = "desc PIDRB\n\nYou can [`read`](crate::Reg::read) this register and get [`pidrb::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PidrbSpec;
impl crate::RegisterSpec for PidrbSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pidrb::R`](R) reader structure"]
impl crate::Readable for PidrbSpec {}
#[doc = "`reset()` method sets PIDRB to value 0"]
impl crate::Resettable for PidrbSpec {}
