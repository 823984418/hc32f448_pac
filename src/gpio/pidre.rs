#[doc = "Register `PIDRE` reader"]
pub type R = crate::R<PidreSpec>;
...
#[doc = "desc PIDRE\n\nYou can [`read`](crate::Reg::read) this register and get [`pidre::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PidreSpec;
impl crate::RegisterSpec for PidreSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pidre::R`](R) reader structure"]
impl crate::Readable for PidreSpec {}
#[doc = "`reset()` method sets PIDRE to value 0"]
impl crate::Resettable for PidreSpec {}
