#[doc = "Register `PODRE` reader"]
pub type R = crate::R<PodreSpec>;
#[doc = "Register `PODRE` writer"]
pub type W = crate::W<PodreSpec>;
...
impl W {
    #[doc = "Bit 0 - desc POUT00"]
    #[inline(always)]
    pub fn pout00(&mut self) -> Pout00W<'_, PodreSpec> {
        Pout00W::new(self, 0)
    }
    #[doc = "Bit 1 - desc POUT01"]
    #[inline(always)]
    pub fn pout01(&mut self) -> Pout01W<'_, PodreSpec> {
        Pout01W::new(self, 1)
    }
    #[doc = "Bit 2 - desc POUT02"]
    #[inline(always)]
    pub fn pout02(&mut self) -> Pout02W<'_, PodreSpec> {
        Pout02W::new(self, 2)
    }
    #[doc = "Bit 3 - desc POUT03"]
    #[inline(always)]
    pub fn pout03(&mut self) -> Pout03W<'_, PodreSpec> {
        Pout03W::new(self, 3)
    }
    #[doc = "Bit 4 - desc POUT04"]
    #[inline(always)]
    pub fn pout04(&mut self) -> Pout04W<'_, PodreSpec> {
        Pout04W::new(self, 4)
    }
    #[doc = "Bit 5 - desc POUT05"]
    #[inline(always)]
    pub fn pout05(&mut self) -> Pout05W<'_, PodreSpec> {
        Pout05W::new(self, 5)
    }
    #[doc = "Bit 6 - desc POUT06"]
    #[inline(always)]
    pub fn pout06(&mut self) -> Pout06W<'_, PodreSpec> {
        Pout06W::new(self, 6)
    }
    #[doc = "Bit 7 - desc POUT07"]
    #[inline(always)]
    pub fn pout07(&mut self) -> Pout07W<'_, PodreSpec> {
        Pout07W::new(self, 7)
    }
    #[doc = "Bit 8 - desc POUT08"]
    #[inline(always)]
    pub fn pout08(&mut self) -> Pout08W<'_, PodreSpec> {
        Pout08W::new(self, 8)
    }
    #[doc = "Bit 9 - desc POUT09"]
    #[inline(always)]
    pub fn pout09(&mut self) -> Pout09W<'_, PodreSpec> {
        Pout09W::new(self, 9)
    }
    #[doc = "Bit 10 - desc POUT10"]
    #[inline(always)]
    pub fn pout10(&mut self) -> Pout10W<'_, PodreSpec> {
        Pout10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc POUT11"]
    #[inline(always)]
    pub fn pout11(&mut self) -> Pout11W<'_, PodreSpec> {
        Pout11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc POUT12"]
    #[inline(always)]
    pub fn pout12(&mut self) -> Pout12W<'_, PodreSpec> {
        Pout12W::new(self, 12)
    }
    #[doc = "Bit 13 - desc POUT13"]
    #[inline(always)]
    pub fn pout13(&mut self) -> Pout13W<'_, PodreSpec> {
        Pout13W::new(self, 13)
    }
    #[doc = "Bit 14 - desc POUT14"]
    #[inline(always)]
    pub fn pout14(&mut self) -> Pout14W<'_, PodreSpec> {
        Pout14W::new(self, 14)
    }
    #[doc = "Bit 15 - desc POUT15"]
    #[inline(always)]
    pub fn pout15(&mut self) -> Pout15W<'_, PodreSpec> {
        Pout15W::new(self, 15)
    }
}
#[doc = "desc PODRE\n\nYou can [`read`](crate::Reg::read) this register and get [`podre::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`podre::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PodreSpec;
impl crate::RegisterSpec for PodreSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`podre::R`](R) reader structure"]
impl crate::Readable for PodreSpec {}
#[doc = "`write(|w| ..)` method takes [`podre::W`](W) writer structure"]
impl crate::Writable for PodreSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PODRE to value 0"]
impl crate::Resettable for PodreSpec {}
