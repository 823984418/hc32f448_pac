...
pub type ChselaR = crate::FieldReader<u16>;
#[doc = "Field `CHSELA` writer - desc CHSELA"]
pub type ChselaW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - desc CHSELA"]
    #[inline(always)]
    pub fn chsela(&self) -> ChselaR {
        ChselaR::new((self.bits & 0xffff) as u16)
    }
}
