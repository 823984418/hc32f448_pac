#[doc = "Register `MCO2CFGR` reader"]
pub type R = crate::R<Mco2cfgrSpec>;
#[doc = "Register `MCO2CFGR` writer"]
pub type W = crate::W<Mco2cfgrSpec>;
...
impl W {
    #[doc = "Bits 0:3 - desc MCOSEL"]
    #[inline(always)]
    pub fn mcosel(&mut self) -> McoselW<'_, Mco2cfgrSpec> {
        McoselW::new(self, 0)
    }
    #[doc = "Bits 4:6 - desc MCODIV"]
    #[inline(always)]
    pub fn mcodiv(&mut self) -> McodivW<'_, Mco2cfgrSpec> {
        McodivW::new(self, 4)
    }
    #[doc = "Bit 7 - desc MCOEN"]
    #[inline(always)]
    pub fn mcoen(&mut self) -> McoenW<'_, Mco2cfgrSpec> {
        McoenW::new(self, 7)
    }
}
...
pub struct Mco2cfgrSpec;
impl crate::RegisterSpec for Mco2cfgrSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`mco2cfgr::R`](R) reader structure"]
impl crate::Readable for Mco2cfgrSpec {}
#[doc = "`write(|w| ..)` method takes [`mco2cfgr::W`](W) writer structure"]
impl crate::Writable for Mco2cfgrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MCO2CFGR to value 0"]
impl crate::Resettable for Mco2cfgrSpec {}
