#[doc = "Register `PLU1_CR` reader"]
pub type R = crate::R<Plu1CrSpec>;
#[doc = "Register `PLU1_CR` writer"]
pub type W = crate::W<Plu1CrSpec>;
...
impl W {
    #[doc = "Bits 0:1 - desc PLMODE"]
    #[inline(always)]
    pub fn plmode(&mut self) -> PlmodeW<'_, Plu1CrSpec> {
        PlmodeW::new(self, 0)
    }
    #[doc = "Bits 8:9 - desc PLINASEL"]
    #[inline(always)]
    pub fn plinasel(&mut self) -> PlinaselW<'_, Plu1CrSpec> {
        PlinaselW::new(self, 8)
    }
    #[doc = "Bits 10:11 - desc PLINBSEL"]
    #[inline(always)]
    pub fn plinbsel(&mut self) -> PlinbselW<'_, Plu1CrSpec> {
        PlinbselW::new(self, 10)
    }
    #[doc = "Bits 12:13 - desc PLINCSEL"]
    #[inline(always)]
    pub fn plincsel(&mut self) -> PlincselW<'_, Plu1CrSpec> {
        PlincselW::new(self, 12)
    }
    #[doc = "Bits 14:15 - desc PLINDSEL"]
    #[inline(always)]
    pub fn plindsel(&mut self) -> PlindselW<'_, Plu1CrSpec> {
        PlindselW::new(self, 14)
    }
}
#[doc = "desc PLU1_CR\n\nYou can [`read`](crate::Reg::read) this register and get [`plu1_cr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`plu1_cr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Plu1CrSpec;
impl crate::RegisterSpec for Plu1CrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`plu1_cr::R`](R) reader structure"]
impl crate::Readable for Plu1CrSpec {}
#[doc = "`write(|w| ..)` method takes [`plu1_cr::W`](W) writer structure"]
impl crate::Writable for Plu1CrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PLU1_CR to value 0"]
impl crate::Resettable for Plu1CrSpec {}
