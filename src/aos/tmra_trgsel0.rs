#[doc = "Register `TMRA_TRGSEL0` reader"]
pub type R = crate::R<TmraTrgsel0Spec>;
#[doc = "Register `TMRA_TRGSEL0` writer"]
pub type W = crate::W<TmraTrgsel0Spec>;
...
impl W {
    #[doc = "Bits 0:8 - desc TRGSEL"]
    #[inline(always)]
    pub fn trgsel(&mut self) -> TrgselW<'_, TmraTrgsel0Spec> {
        TrgselW::new(self, 0)
    }
    #[doc = "Bits 16:18 - desc PLCHSEL"]
    #[inline(always)]
    pub fn plchsel(&mut self) -> PlchselW<'_, TmraTrgsel0Spec> {
        PlchselW::new(self, 16)
    }
    #[doc = "Bits 30:31 - desc COMEN"]
    #[inline(always)]
    pub fn comen(&mut self) -> ComenW<'_, TmraTrgsel0Spec> {
        ComenW::new(self, 30)
    }
}
#[doc = "desc TMRA_TRGSEL0\n\nYou can [`read`](crate::Reg::read) this register and get [`tmra_trgsel0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tmra_trgsel0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TmraTrgsel0Spec;
impl crate::RegisterSpec for TmraTrgsel0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tmra_trgsel0::R`](R) reader structure"]
impl crate::Readable for TmraTrgsel0Spec {}
#[doc = "`write(|w| ..)` method takes [`tmra_trgsel0::W`](W) writer structure"]
impl crate::Writable for TmraTrgsel0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TMRA_TRGSEL0 to value 0x01ff"]
impl crate::Resettable for TmraTrgsel0Spec {
