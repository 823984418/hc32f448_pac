#[doc = "Register `FRST3` reader"]
pub type R = crate::R<Frst3Spec>;
#[doc = "Register `FRST3` writer"]
pub type W = crate::W<Frst3Spec>;
...
impl W {
    #[doc = "Bit 0 - desc ADC1"]
    #[inline(always)]
    pub fn adc1(&mut self) -> Adc1W<'_, Frst3Spec> {
        Adc1W::new(self, 0)
    }
    #[doc = "Bit 1 - desc ADC2"]
    #[inline(always)]
    pub fn adc2(&mut self) -> Adc2W<'_, Frst3Spec> {
        Adc2W::new(self, 1)
    }
    #[doc = "Bit 2 - desc ADC3"]
    #[inline(always)]
    pub fn adc3(&mut self) -> Adc3W<'_, Frst3Spec> {
        Adc3W::new(self, 2)
    }
    #[doc = "Bit 4 - desc DAC"]
    #[inline(always)]
    pub fn dac(&mut self) -> DacW<'_, Frst3Spec> {
        DacW::new(self, 4)
    }
    #[doc = "Bit 8 - desc CMP12"]
    #[inline(always)]
    pub fn cmp12(&mut self) -> Cmp12W<'_, Frst3Spec> {
        Cmp12W::new(self, 8)
    }
    #[doc = "Bit 9 - desc CMP34"]
    #[inline(always)]
    pub fn cmp34(&mut self) -> Cmp34W<'_, Frst3Spec> {
        Cmp34W::new(self, 9)
    }
    #[doc = "Bit 16 - desc SMC"]
    #[inline(always)]
    pub fn smc(&mut self) -> SmcW<'_, Frst3Spec> {
        SmcW::new(self, 16)
    }
    #[doc = "Bit 20 - desc USART1"]
    #[inline(always)]
    pub fn usart1(&mut self) -> Usart1W<'_, Frst3Spec> {
        Usart1W::new(self, 20)
    }
    #[doc = "Bit 21 - desc USART2"]
    #[inline(always)]
    pub fn usart2(&mut self) -> Usart2W<'_, Frst3Spec> {
        Usart2W::new(self, 21)
    }
    #[doc = "Bit 22 - desc USART3"]
    #[inline(always)]
    pub fn usart3(&mut self) -> Usart3W<'_, Frst3Spec> {
        Usart3W::new(self, 22)
    }
    #[doc = "Bit 23 - desc USART4"]
    #[inline(always)]
    pub fn usart4(&mut self) -> Usart4W<'_, Frst3Spec> {
        Usart4W::new(self, 23)
    }
    #[doc = "Bit 24 - desc USART5"]
    #[inline(always)]
    pub fn usart5(&mut self) -> Usart5W<'_, Frst3Spec> {
        Usart5W::new(self, 24)
    }
    #[doc = "Bit 25 - desc USART6"]
    #[inline(always)]
    pub fn usart6(&mut self) -> Usart6W<'_, Frst3Spec> {
        Usart6W::new(self, 25)
    }
}
#[doc = "desc FRST3\n\nYou can [`read`](crate::Reg::read) this register and get [`frst3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`frst3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Frst3Spec;
impl crate::RegisterSpec for Frst3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`frst3::R`](R) reader structure"]
impl crate::Readable for Frst3Spec {}
#[doc = "`write(|w| ..)` method takes [`frst3::W`](W) writer structure"]
impl crate::Writable for Frst3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FRST3 to value 0xffff_ffff"]
impl crate::Resettable for Frst3Spec {
