#[doc = "Register `FRST0` reader"]
pub type R = crate::R<Frst0Spec>;
#[doc = "Register `FRST0` writer"]
pub type W = crate::W<Frst0Spec>;
...
impl W {
    #[doc = "Bit 13 - desc KEY"]
    #[inline(always)]
    pub fn key(&mut self) -> KeyW<'_, Frst0Spec> {
        KeyW::new(self, 13)
    }
    #[doc = "Bit 14 - desc DMA1"]
    #[inline(always)]
    pub fn dma1(&mut self) -> Dma1W<'_, Frst0Spec> {
        Dma1W::new(self, 14)
    }
    #[doc = "Bit 15 - desc DMA2"]
    #[inline(always)]
    pub fn dma2(&mut self) -> Dma2W<'_, Frst0Spec> {
        Dma2W::new(self, 15)
    }
    #[doc = "Bit 16 - desc FCM"]
    #[inline(always)]
    pub fn fcm(&mut self) -> FcmW<'_, Frst0Spec> {
        FcmW::new(self, 16)
    }
    #[doc = "Bit 17 - desc AOS"]
    #[inline(always)]
    pub fn aos(&mut self) -> AosW<'_, Frst0Spec> {
        AosW::new(self, 17)
    }
    #[doc = "Bit 18 - desc CTC"]
    #[inline(always)]
    pub fn ctc(&mut self) -> CtcW<'_, Frst0Spec> {
        CtcW::new(self, 18)
    }
    #[doc = "Bit 20 - desc AES"]
    #[inline(always)]
    pub fn aes(&mut self) -> AesW<'_, Frst0Spec> {
        AesW::new(self, 20)
    }
    #[doc = "Bit 21 - desc HASH"]
    #[inline(always)]
    pub fn hash(&mut self) -> HashW<'_, Frst0Spec> {
        HashW::new(self, 21)
    }
    #[doc = "Bit 22 - desc TRNG"]
    #[inline(always)]
    pub fn trng(&mut self) -> TrngW<'_, Frst0Spec> {
        TrngW::new(self, 22)
    }
    #[doc = "Bit 23 - desc CRC"]
    #[inline(always)]
    pub fn crc(&mut self) -> CrcW<'_, Frst0Spec> {
        CrcW::new(self, 23)
    }
    #[doc = "Bit 24 - desc DCU1"]
    #[inline(always)]
    pub fn dcu1(&mut self) -> Dcu1W<'_, Frst0Spec> {
        Dcu1W::new(self, 24)
    }
    #[doc = "Bit 25 - desc DCU2"]
    #[inline(always)]
    pub fn dcu2(&mut self) -> Dcu2W<'_, Frst0Spec> {
        Dcu2W::new(self, 25)
    }
    #[doc = "Bit 26 - desc DCU3"]
    #[inline(always)]
    pub fn dcu3(&mut self) -> Dcu3W<'_, Frst0Spec> {
        Dcu3W::new(self, 26)
    }
    #[doc = "Bit 27 - desc DCU4"]
    #[inline(always)]
    pub fn dcu4(&mut self) -> Dcu4W<'_, Frst0Spec> {
        Dcu4W::new(self, 27)
    }
}
#[doc = "desc FRST0\n\nYou can [`read`](crate::Reg::read) this register and get [`frst0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`frst0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Frst0Spec;
impl crate::RegisterSpec for Frst0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`frst0::R`](R) reader structure"]
impl crate::Readable for Frst0Spec {}
#[doc = "`write(|w| ..)` method takes [`frst0::W`](W) writer structure"]
impl crate::Writable for Frst0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FRST0 to value 0xffff_ffff"]
impl crate::Resettable for Frst0Spec {
