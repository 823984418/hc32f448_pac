...
impl W {
    #[doc = "Bit 0 - desc DR0"]
    #[inline(always)]
    pub fn dr0(&mut self) -> Dr0W<'_, Dadr1Spec> {
        Dr0W::new(self, 0)
    }
    #[doc = "Bit 1 - desc DR1"]
    #[inline(always)]
    pub fn dr1(&mut self) -> Dr1W<'_, Dadr1Spec> {
        Dr1W::new(self, 1)
    }
    #[doc = "Bit 2 - desc DR2"]
    #[inline(always)]
    pub fn dr2(&mut self) -> Dr2W<'_, Dadr1Spec> {
        Dr2W::new(self, 2)
    }
    #[doc = "Bit 3 - desc DR3"]
    #[inline(always)]
    pub fn dr3(&mut self) -> Dr3W<'_, Dadr1Spec> {
        Dr3W::new(self, 3)
    }
    #[doc = "Bit 4 - desc DL0R4"]
    #[inline(always)]
    pub fn dl0r4(&mut self) -> Dl0r4W<'_, Dadr1Spec> {
        Dl0r4W::new(self, 4)
    }
    #[doc = "Bit 5 - desc DL1R5"]
    #[inline(always)]
    pub fn dl1r5(&mut self) -> Dl1r5W<'_, Dadr1Spec> {
        Dl1r5W::new(self, 5)
    }
    #[doc = "Bit 6 - desc DL2R6"]
    #[inline(always)]
    pub fn dl2r6(&mut self) -> Dl2r6W<'_, Dadr1Spec> {
        Dl2r6W::new(self, 6)
    }
    #[doc = "Bit 7 - desc DL3R7"]
    #[inline(always)]
    pub fn dl3r7(&mut self) -> Dl3r7W<'_, Dadr1Spec> {
        Dl3r7W::new(self, 7)
    }
    #[doc = "Bit 8 - desc DL4R8"]
    #[inline(always)]
    pub fn dl4r8(&mut self) -> Dl4r8W<'_, Dadr1Spec> {
        Dl4r8W::new(self, 8)
    }
    #[doc = "Bit 9 - desc DL5R9"]
    #[inline(always)]
    pub fn dl5r9(&mut self) -> Dl5r9W<'_, Dadr1Spec> {
        Dl5r9W::new(self, 9)
    }
    #[doc = "Bit 10 - desc DL6R10"]
    #[inline(always)]
    pub fn dl6r10(&mut self) -> Dl6r10W<'_, Dadr1Spec> {
        Dl6r10W::new(self, 10)
    }
    #[doc = "Bit 11 - desc DL7R11"]
    #[inline(always)]
    pub fn dl7r11(&mut self) -> Dl7r11W<'_, Dadr1Spec> {
        Dl7r11W::new(self, 11)
    }
    #[doc = "Bit 12 - desc DL8"]
    #[inline(always)]
    pub fn dl8(&mut self) -> Dl8W<'_, Dadr1Spec> {
        Dl8W::new(self, 12)
    }
    #[doc = "Bit 13 - desc DL9"]
    #[inline(always)]
    pub fn dl9(&mut self) -> Dl9W<'_, Dadr1Spec> {
        Dl9W::new(self, 13)
    }
    #[doc = "Bit 14 - desc DL10"]
    #[inline(always)]
    pub fn dl10(&mut self) -> Dl10W<'_, Dadr1Spec> {
        Dl10W::new(self, 14)
    }
    #[doc = "Bit 15 - desc DL11"]
    #[inline(always)]
    pub fn dl11(&mut self) -> Dl11W<'_, Dadr1Spec> {
        Dl11W::new(self, 15)
    }
}
