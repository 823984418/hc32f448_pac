...
#[doc = "Field `CWDE` reader - desc CWDE"]
pub type CwdeR = crate::BitReader;
#[doc = "Field `CWDE` writer - desc CWDE"]
pub type CwdeW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 1 - desc CWDE"]
    #[inline(always)]
    pub fn cwde(&self) -> CwdeR {
        CwdeR::new(((self.bits >> 1) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - desc CWDE"]
    #[inline(always)]
    pub fn cwde(&mut self) -> CwdeW<'_, MdrSpec> {
        CwdeW::new(self, 1)
    }
    #[doc = "Bits 2:3 - desc CSMD"]
    #[inline(always)]
